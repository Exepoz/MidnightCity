...
Config.reqTow = true
Config.dropprice = math.random(100,500) -- Price of each dropoff
...
Config.PedPos = vector4(495.81, -1340.93, 29.31, 15.44)
Config.Locations = {
    ["main"] = {
        label = "Towing HQ",
        coords = vector4(495.81, -1340.93, 29.31, 15.44),
    },
    ["vehicle"] = {
        label = "Flatbed",
        coords = vector4(484.13, -1333.29, 29.29, 280.41),
    },
    ["towspots"] = {
