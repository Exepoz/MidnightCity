...
Config.InventoryType = 'ps' -- (qb, ox, lj, quasar, neither) What inventory you are using? if you are using a renamed inventory resource you can use that here as well for qb-inventory or lj-inventory renames only.
Config.Phone = "renewed" -- (quasar) (renewed) (gks) (qb) (road) Whatever phone script you are using for email when a tournament starts. (event is "Pug:client:TournamentHasBecomeAvilable" in open.lua)
----------
...
Config.LockInventory = true -- Make this true if you want players inventory to be locked every time they use a fishing rod and unlocked when they are done catching the fish
...
Config.RemoveFishingRepWhenCraftRod = true -- Make this true if you want the player to have the fishing rep required to craft the fishing rod removed from the player when they craft the fishing rod.
...
Config.TournamentTimeToSignUp = 20 -- (Minutes) How long do player have to sign up after a tournament becomes available aka how many seconds is Config.TournamentCooldowns | Default is set to 15 minutes
----------
----------
...
----------
----------
Config.SellShopPed = nil -- Fishing sell shop ped model
Config.SellShopPedPedLoc = nil -- Fishing sell Shop ped location
----------
----------
Config.GemsBuyingPed = nil -- Gems sell Shop ped
Config.GemsBuyingPedLoc = nil -- Gems Buying Ped Location
----------
----------
Config.CrafingRodLocation = vector3(-679.12, 5790.83, 17.33) -- crafting fishing rods location
----------
----------
Config.MaxFisherMan = 20 -- Max fishermen in tournaments
...
Config.WaitForFIshToBiteMax = 35 --(seconds) Minimum amount of seconds it can take for a fish to bite the bait
----------
----------
...
Config.NeededAttemptsMax = 1 -- maximum ammout of times you need to do the skillcheck
----------
----------
...
Config.NW_fishingGame = true -- make this true if you only want to use NW_fishingGame for all fishing rod minigames (MAKE SURE Config.AllUsesPsUiLock IS FALSE)
