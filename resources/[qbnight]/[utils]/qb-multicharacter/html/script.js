                    ...
                    setTimeout(function(){
                        ...
                        $(".title-screen").fadeIn(0, function() {
                            setTimeout(function() {
                                ...
                                qbMultiCharacters.fadeInDown('.imagenlogo', '25%', 2500);
                        ...
                        $(".btn-iniciar").mouseenter(function() {
                            over_button.volume = 0.06
                            over_button.play();
                        });
                        $("#play, .btn-iniciar").click(function() {
                            confirmar.volume = 0.06
                            confirmar.play();
                        });
                    }, 2000);
                }, 2000);
                console.log("Play Music")
                background = new Audio("musica.mp3");
...
function setupCharInfo(cData) {
    if (cData == 'empty') {
        ...
        '<div class="character-info-box"><span id="info-label">Gang: </span><span class="char-info-js">'+cData.charinfo.gang+'</span></div>');
    }
}
