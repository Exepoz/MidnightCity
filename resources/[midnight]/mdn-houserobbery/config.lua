...
Config.ItemsReward = {
    {item = "diamond_ring",                     	amt = {min = 1, max = 2}, probability = 1/15},
    {item = "pistol_ammo",            	amt = {min = 2, max = 5}, probability = 1/10},
    {item = "bandage",                 	amt = {min = 3, max = 6}, probability = 1/10},
    {item = "oxy",                     	amt = {min = 2, max = 3}, probability = 1/10},
    {item = "gratefuldead_tabs",        	amt = {min = 1, max = 4}, probability = 1/10},
    {item = "bong",                     	amt = {min = 1, max = 1}, probability = 1/10},
    {item = "tablet",                 	amt = {min = 1, max = 1}, probability = 1/15},
    {item = "joint",         		amt = {min = 5, max = 12}, probability = 1/10},
    {item = "shrooms",         	amt = {min = 3, max = 6}, probability = 1/10},
    {item = "10kgoldchain",             	amt = {min = 1, max = 1}, probability = 1/15},
    {item = "goldbar",            	amt = {min = 1, max = 1}, probability = 1/25},
    {item = "armor",                 	amt = {min = 1, max = 2}, probability = 1/8},
    {item = "heroin_ready",     	amt = {min = 2, max = 5}, probability = 1/7},
    {item = "lockpick",                 	amt = {min = 1, max = 5}, probability = 1/5},
    {item = "weapon_switchblade",     	amt = {min = 1, max = 1}, probability = 1/10},
   	{item = "cokebaggystagetwo",         	amt = {min = 4, max = 10}, probability = 1/10},
    {item = "cash",                     	amt = {min = 150, max = 600}, probability = 1/15},
    {item = "weapontint_mk2_14",            	amt = {min = 1, max = 1}, probability = 1/15},
    {item = "phone",         	amt = {min = 1, max = 1}, probability = 1/15},
    {item = "tab_paper",         	amt = {min = 1, max = 1}, probability = 1/13},
    {item = "samsungphone",             	amt = {min = 1, max = 1}, probability = 1/16},
    {item = "monitor",                	amt = {min = 1, max = 2}, probability = 1/10},
    {item = "rolex",                 	amt = {min = 1, max = 1}, probability = 1/10},
    {item = "laptop",                 	amt = {min = 1, max = 1}, probability = 1/10},
    {item = "captainskull",                 	amt = {min = 1, max = 1}, probability = 1/55},
    {item = "watch",                     	amt = {min = 1, max = 3}, probability = 1/5},
    {item = "xanax_prescription",                 	amt = {min = 1, max = 4}, probability = 1/5},
    {item = "vodka",                 	amt = {min = 1, max = 3}, probability = 1/5},
    {item = "toiletry",                	amt = {min = 1, max = 3}, probability = 1/5},
    {item = "toothpaste",             	amt = {min = 1, max = 2}, probability = 1/5},
    {item = "shoebox",                 	amt = {min = 1, max = 1}, probability = 1/5},
    {item = "dj_deck",                 	amt = {min = 1, max = 1}, probability = 1/10},
    {item = "earrings",                 	amt = {min = 1, max = 1}, probability = 1/5},
    {item = "console",                 	amt = {min = 1, max = 1}, probability = 1/5},
    {item = "hairdryer",             	amt = {min = 1, max = 1}, probability = 1/5},
    {item = "laptop",                 	amt = {min = 1, max = 1}, probability = 1/11},
    {item = "soap",                     	amt = {min = 1, max = 3}, probability = 1/5},
    {item = "whiskey",                	amt = {min = 2, max = 5}, probability = 1/5},
    {item = "iphone",                 	amt = {min = 1, max = 1}, probability = 1/5},
    {item = "cash",                     	amt = {min = 350, max = 900}, probability = 1/15},
