...
Config.Burnerphones = {
    ...
    ['burnerphone_ran'] = {
        ...
        Rewards = {
            ...
            [2] = {item = 'heavyarmor', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [3] = {item = 'armor', qty = {min = 1, max = 3}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [4] = {item = 'racingtablet', qty = {min = 1, max = 1}, weight = 40, prop = "prop_cs_package_01", emote = "mechanic4"},
            [5] = {item = 'nikon', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [6] = {item = 'nos', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [7] = {item = 'anglegrinder', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [8] = {item = 'powersaw', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [9] = {item = 'flightbox', qty = {min = 1, max = 1}, weight = 40, prop = "prop_cs_package_01", emote = "mechanic4"},
            [10] = {item = 'origami1', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [11] = {item = 'origami2', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [12] = {item = 'origami3', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [13] = {item = 'origami4', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [14] = {item = 'origami5', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [15] = {item = 'origami6', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [16] = {item = 'origami7', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [17] = {item = 'origami8', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [18] = {item = 'origami9', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [19] = {item = 'origami10', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [20] = {item = 'origami11', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [21] = {item = 'origami12', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [22] = {item = 'origami13', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [23] = {item = 'origami14', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [24] = {item = 'origami15', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [25] = {item = 'origami16', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [26] = {item = 'origami17', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [27] = {item = 'origami18', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [28] = {item = 'origami19', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [29] = {item = 'origami20', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [30] = {item = 'origami21', qty = {min = 1, max = 1}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
        }
    },
    ['burnerphone_loot'] = {
        CallCops = true,
        ...
        Rewards = {
            ...
            [5] = {item = 'tenkgoldchain',  qty = {min = 3, max = 8}, weight = 40, prop = "prop_cs_package_01", emote = "mechanic4"},
    ...
    ['burnerphone_drugs'] = {
        ...
        Rewards = {
            ...
            [3] = {item = 'cokebaggy', qty = {min = 10, max = 20}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [4] = {item = 'cokebaggystagetwo', qty = {min = 5, max = 20}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [5] = {item = 'cokebaggystagethree', qty = {min = 5, max = 30}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [6] = {item = 'heroin_ready', qty = {min = 5, max = 20}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [7] = {item = 'heroin_readystagetwo', qty = {min = 5, max = 20}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            [8] = {item = 'heroin_readystagethree', qty = {min = 2, max = 8}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            --[9] = {item = 'crack_baggy', qty = {min = 5, max = 20}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            --[10] = {item = '', qty = {min = 5, max = 20}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
            --[11] = {item = 'heroin_readystagethree', qty = {min = 2, max = 8}, weight = 50, prop = "prop_cs_package_01", emote = "mechanic4"},
        }
    },
}
