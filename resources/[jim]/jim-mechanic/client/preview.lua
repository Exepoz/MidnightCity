...
local function printDifferences(vehicle, properties, newproperties)
	...
	if properties["color1"] ~= newproperties["color1"] then
		if type(newproperties["color1"]) ~= "table" then
			...
			vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].primary.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metallic..") ]" modlist[#modlist+1] = {['i'] = 'color1', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metallic..")", ["item"] = Loc[Config.Lan]["paint"].primary.." - "..QBCore.Shared.Items["paintcan"].label } end end
			for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMatte) do if newproperties["color1"] == v.id then
			vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].primary.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].matte..") ]" modlist[#modlist+1] = {['i'] = 'color1', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].matte..")", ["item"] = Loc[Config.Lan]["paint"].primary.." - "..QBCore.Shared.Items["paintcan"].label } end end
			for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMetals) do if newproperties["color1"] == v.id then
			vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].primary.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metals..") ]" modlist[#modlist+1] = {['i'] = 'color1', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metals..")", ["item"] = Loc[Config.Lan]["paint"].primary.." - "..QBCore.Shared.Items["paintcan"].label } end end
			for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsChameleon) do if newproperties["color1"] == v.id then
			vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].primary.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].chameleon..") ]" modlist[#modlist+1] = {['i'] = 'color1', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].chameleon..")", ["item"] = Loc[Config.Lan]["paint"].primary.." - "..QBCore.Shared.Items["paintcan"].label } end end
		end
	end
	if properties["color2"] ~= newproperties["color2"] then
		if type(newproperties["color2"]) ~= "table" then
			...
			vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].secondary.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metallic..") ]" modlist[#modlist+1] = {['i'] = 'color2', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metallic..")", ["item"] = Loc[Config.Lan]["paint"].secondary.." - "..QBCore.Shared.Items["paintcan"].label } end end
			for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMatte) do if newproperties["color2"] == v.id then
			vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].secondary.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].matte..") ]" modlist[#modlist+1] = {['i'] = 'color2', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].matte..")", ["item"] = Loc[Config.Lan]["paint"].secondary.." - "..QBCore.Shared.Items["paintcan"].label } end end
			for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMetals) do if newproperties["color2"] == v.id then
			vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].secondary.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metals..") ]" modlist[#modlist+1] = {['i'] = 'color2', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metals..")", ["item"] = Loc[Config.Lan]["paint"].secondary.." - "..QBCore.Shared.Items["paintcan"].label } end end
			for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsChameleon) do if newproperties["color2"] == v.id then
			vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].secondary.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].chameleon..") ]" modlist[#modlist+1] = {['i'] = 'color2', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].chameleon..")", ["item"] = Loc[Config.Lan]["paint"].secondary.." - "..QBCore.Shared.Items["paintcan"].label } end end
		end
	end
	if properties["pearlescentColor"] ~= newproperties["pearlescentColor"] then
		...
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].pearl.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metallic..") ]" modlist[#modlist+1] = {['i'] = 'pearlescentColor', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metallic..")", ["item"] = Loc[Config.Lan]["paint"].pearl.." - "..QBCore.Shared.Items["paintcan"].label } end end
		for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMatte) do if newproperties["pearlescentColor"] == v.id then
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].pearl.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].matte..") ]" modlist[#modlist+1] = {['i'] = 'pearlescentColor', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].matte..")", ["item"] = Loc[Config.Lan]["paint"].pearl.." - "..QBCore.Shared.Items["paintcan"].label } end end
		for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMetals) do if newproperties["pearlescentColor"] == v.id then
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].pearl.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metals..") ]" modlist[#modlist+1] = {['i'] = 'pearlescentColor', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metals..")", ["item"] = Loc[Config.Lan]["paint"].pearl.." - "..QBCore.Shared.Items["paintcan"].label } end end
		for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsChameleon) do if newproperties["pearlescentColor"] == v.id then
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].pearl.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].chameleon..") ]" modlist[#modlist+1] = {['i'] = 'pearlescentColor', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].chameleon..")", ["item"] = Loc[Config.Lan]["paint"].pearl.." - "..QBCore.Shared.Items["paintcan"].label } end end
	end
	if properties["wheelColor"] ~= newproperties["wheelColor"] then
		...
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].wheel.." Color - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metallic..") ]" modlist[#modlist+1] = {['i'] = 'wheelColor', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metallic..")", ["item"] = Loc[Config.Lan]["paint"].wheel.." - "..QBCore.Shared.Items["paintcan"].label } end end
		for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMatte) do if newproperties["wheelColor"] == v.id then
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].wheel.."Color - [ "..v.name.." ("..Loc[Config.Lan]["paint"].matte..") ]" modlist[#modlist+1] = {['i'] = 'wheelColor', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].matte..")", ["item"] = Loc[Config.Lan]["paint"].wheel.." - "..QBCore.Shared.Items["paintcan"].label } end end
		for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMetals) do if newproperties["wheelColor"] == v.id then
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].wheel.."Color - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metals..") ]" modlist[#modlist+1] = {['i'] = 'wheelColor', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metals..")", ["item"] = Loc[Config.Lan]["paint"].wheel.." - "..QBCore.Shared.Items["paintcan"].label } end end
		for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsChameleon) do if newproperties["wheelColor"] == v.id then
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].wheel.."Color - [ "..v.name.." ("..Loc[Config.Lan]["paint"].chameleon..") ]" modlist[#modlist+1] = {['i'] = 'wheelColor', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].chameleon..")", ["item"] = Loc[Config.Lan]["paint"].wheel.." - "..QBCore.Shared.Items["paintcan"].label } end end
	end
	if properties["dashboardColor"] ~= newproperties["dashboardColor"] then
		...
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].dashboard.."Color - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metallic..") ]" modlist[#modlist+1] = {['i'] = 'dashboardColor', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metallic..")", ["item"] = Loc[Config.Lan]["paint"].dashboard.." - "..QBCore.Shared.Items["paintcan"].label } end end
		for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMatte) do if newproperties["dashboardColor"] == v.id then
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].dashboard.."Color - [ "..v.name.." ("..Loc[Config.Lan]["paint"].matte..") ]" modlist[#modlist+1] = {['i'] = 'dashboardColor', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].matte..")", ["item"] = Loc[Config.Lan]["paint"].dashboard.." - "..QBCore.Shared.Items["paintcan"].label } end end
		for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMetals) do if newproperties["dashboardColor"] == v.id then
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].dashboard.."Color - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metals..") ]" modlist[#modlist+1] = {['i'] = 'dashboardColor', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metals..")", ["item"] = Loc[Config.Lan]["paint"].dashboard.." - "..QBCore.Shared.Items["paintcan"].label } end end
	end
	if properties["interiorColor"] ~= newproperties["interiorColor"] then
		...
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].interior.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metallic..") ]" modlist[#modlist+1] = {['i'] = 'interiorColor', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metallic..")", ["item"] = Loc[Config.Lan]["paint"].interior.." - "..QBCore.Shared.Items["paintcan"].label } end end
		for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMatte) do if newproperties["interiorColor"] == v.id then
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].interior.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].matte..") ]" modlist[#modlist+1] = {['i'] = 'interiorColor', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].matte..")", ["item"] = Loc[Config.Lan]["paint"].interior.." - "..QBCore.Shared.Items["paintcan"].label } end end
		for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMetals) do if newproperties["interiorColor"] == v.id then
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].interior.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metals..") ]" modlist[#modlist+1] = {['i'] = 'interiorColor', ['t'] = 'paint', ['p'] = v.id, ['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metals..")", ["item"] = Loc[Config.Lan]["paint"].interior.." - "..QBCore.Shared.Items["paintcan"].label } end end
	end
	...
	if properties["windowTint"] ~= newproperties["windowTint"] then
		...
		if newproperties["windowTint"] == 0 then name = "Stock"
			...
			for k, v in pairs(Loc[Config.Lan].vehicleWindowOptions) do
				if v.id == newproperties["windowTint"] then name = v.name chosenTint = v.id end
			end
		end
		vehlist[#vehlist+1] = Loc[Config.Lan]["windows"].menuheader.." - [ "..name.." ] - "
		modlist[#modlist+1] = {['i'] = 'tint_supplies', ['chosenTint'] = chosenTint, ['type'] = "("..name..")", ["item"] = Loc[Config.Lan]["windows"].menuheader.." - "..QBCore.Shared.Items["tint_supplies"].label }
	end
	...
	local conTable = {
		["modSpoilers"] = { mod = 0, label = Loc[Config.Lan]["check"].label15, item = QBCore.Shared.Items["spoiler"].label, i = 'spoiler'},
		["modFrontBumper"] = { mod = 1, label = Loc[Config.Lan]["check"].label16, item = QBCore.Shared.Items["bumper"].label, i = 'bumper' },
		["modRearBumper"] = { mod = 2, label = Loc[Config.Lan]["check"].label17, item = QBCore.Shared.Items["bumper"].label, i = 'bumper' },
		["modSideSkirt"] = { mod = 3, label = Loc[Config.Lan]["check"].label18, item = QBCore.Shared.Items["skirts"].label, i = 'skirts' },
		["modExhaust"] = { mod = 4, label = Loc[Config.Lan]["check"].label19, item = QBCore.Shared.Items["exhaust"].label, i = 'exhaust' },
		["modGrille"] = { mod = 6, label = Loc[Config.Lan]["check"].label20, item = QBCore.Shared.Items["bumper"].label, i = 'bumper' },
		["modHood"] = { mod = 7, label = Loc[Config.Lan]["check"].label21, item = QBCore.Shared.Items["hood"].label, i = 'hood' },
		["modFender"] = { mod = 8, label = Loc[Config.Lan]["check"].label22, item = QBCore.Shared.Items["skirts"].label, i = 'skirts' },
		["modRightFender"] = { mod = 9, label = Loc[Config.Lan]["check"].label23, item = QBCore.Shared.Items["skirts"].label, i = 'skirts' },
		["modRoof"] = { mod = 10, label = Loc[Config.Lan]["check"].label24, item = QBCore.Shared.Items["roof"].label, i = 'roof' },
		["modPlateHolder"] = { mod = 25, label = Loc[Config.Lan]["check"].label25, item = QBCore.Shared.Items["customplate"].label, i = 'customplate' },
		["modVanityPlate"] = { mod = 26, label = Loc[Config.Lan]["check"].label26, item = QBCore.Shared.Items["customplate"].label, i = 'customplate' },
		["modTrimA"] = { mod = 27, label = Loc[Config.Lan]["check"].label27, item = QBCore.Shared.Items["externals"].label, i = 'externals' },
		["modTrimB"] = { mod = 44, label = Loc[Config.Lan]["check"].label28, item = QBCore.Shared.Items["externals"].label, i = 'externals' },
		["modTrunk"] = { mod = 37, label = Loc[Config.Lan]["check"].label29, item = QBCore.Shared.Items["externals"].label, i = 'externals' },
		["modEngineBlock"] = { mod = 39, label = Loc[Config.Lan]["check"].label30, item = QBCore.Shared.Items["externals"].label, i = 'externals' },
		["modAirFilter"] = { mod = 40, label = Loc[Config.Lan]["check"].label31, item = QBCore.Shared.Items["externals"].label, i = 'externals' },
		["modStruts"] = { mod = 41, label = Loc[Config.Lan]["check"].label32, item = QBCore.Shared.Items["externals"].label, i = 'externals' },
		["modArchCover"] = { mod = 42, label = Loc[Config.Lan]["check"].label33, item = QBCore.Shared.Items["externals"].label, i = 'externals' },
		["modFrame"] = { mod = 5, label = Loc[Config.Lan]["check"].label34, item = QBCore.Shared.Items["rollcage"].label, i = 'rollcage' },
		["modOrnaments"] = { mod = 28, label = Loc[Config.Lan]["check"].label35, item = QBCore.Shared.Items["internals"].label, i = 'internals'},
		["modDashboard"] = { mod = 29, label = Loc[Config.Lan]["check"].label36, item = QBCore.Shared.Items["internals"].label , i = 'internals'},
		["modDial"] = { mod = 30, label = Loc[Config.Lan]["check"].label37, item = QBCore.Shared.Items["internals"].label, i = 'internals' },
		["modDoorSpeaker"] = { mod = 31, label = Loc[Config.Lan]["check"].label38, item = QBCore.Shared.Items["internals"].label, i = 'internals' },
		["modSeats"] = { mod = 32, label = Loc[Config.Lan]["check"].label39, item = QBCore.Shared.Items["seat"].label, i = 'seat' },
		["modSteeringWheel"] = { mod = 33, label = Loc[Config.Lan]["check"].label40, item = QBCore.Shared.Items["internals"].label, i = 'internals' },
		["modShifterLeavers"] = { mod = 34, label = Loc[Config.Lan]["check"].label41, item = QBCore.Shared.Items["internals"].label, i = 'internals' },
		["modAPlate"] = { mod = 35, label = Loc[Config.Lan]["check"].label42, item = QBCore.Shared.Items["internals"].label, i = 'internals' },
		["modSpeakers"] = { mod = 36, label = Loc[Config.Lan]["check"].label43, item = QBCore.Shared.Items["internals"].label, i = 'internals' },
		["modHydrolic"] = { mod = 38, label = Loc[Config.Lan]["check"].label44, item = QBCore.Shared.Items["externals"].label, i = 'externals' },
		["modAerials"] = { mod = 43, label = Loc[Config.Lan]["check"].label45, item = QBCore.Shared.Items["externals"].label, i = 'externals' },
		["modTank"] = { mod = 45, label = Loc[Config.Lan]["check"].label46, item = QBCore.Shared.Items["externals"].label, i = 'externals' },
        ["modLivery"] = { mod = 48, label = Loc[Config.Lan]["check"].label53, item = QBCore.Shared.Items["livery"].label, i = 'livery' },
	}
		...
		if properties[k] ~= newproperties[k] then
			for l in pairs(conTable) do
				if conTable[k] then
					...
					modlist[#modlist+1] = {['type'] = "("..label..")", ["item"] = conTable[k].label..tostring(newproperties[k]+1 .." ] - "..conTable[k].item), ['i'] = conTable[k].i, ['chosenMod'] = newproperties[k]+1, ['mod'] = conTable[k].mod}
					break
				end
			end
		end
