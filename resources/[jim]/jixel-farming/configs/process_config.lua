...
Process = {
    Juicer = {
        ...
        Setup = {
            Locations = {
                { coords = vec4(405.6, 6526.34, 27.7, 86.5), h = 176.5, l = 2.6, w = 0.7, minZ = 27.2, maxZ = 28.3,
    ...
    Processor = {
        ...
        Setup = {
            Locations = {
                ...
                prop = "prop_table_03", prop2 = "prop_tea_urn", prop2loc = vec4(428.87, 6478.52, 29.6, 160.0)},
            }
        }
    },
    ...
    Pestle = {
        ...
        Setup = {
            Locations = {
                { coords = vec4(2899.32, 4399.09, 50.2, 207.61), l = 0.6, w = 0.6, minZ = 29.5, maxZ = 30.5,
	...
	MilkProcess = {
        ...
        BlipSettings = {
		    ...
		    BlipSprite = 274, BlipColor = 21,
		    BlipLoc = vec4(2558.00, 4675.58, 34.88, 58.28),
        },
        Setup = {
            Locations = {
                { coords = vec4(2558.00, 4675.58, 34.08, 58.28), h = 217.39, l = 2.5, w = 2.5, minZ = 33.5, maxZ = 34.0,
                prop = "prop_table_03", prop2 = "prop_old_churn_02", prop2loc = vec4(2558.00, 4675.58, 34.88, 58.28)
        ...
        MilkBucketSetup = {
            ...
            MultibucketOptions = {1, 5, 10},
                BucketLocations = {
                    ...
                    h = 314.9, l = 0.6, w = 0.6, minZ = 20.5, maxZ = 30.5,
    ...
    MeatProcess = {
        ...
        Targets = {
            ...
            Drying = {
                ...
                prop = "prop_table_03", prop2 = "prop_tea_urn", prop2loc = vec4(4930.53, -5293.55, 5.57, 270.0)},
            },
            Curing = {
