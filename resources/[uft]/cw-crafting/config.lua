...
Config.CraftingTables = {
	['basic'] = {
		...
		locations = {  vector3(970.25, -1548.25, 30.60), }
	},
	['mechanic'] = {
	...
	['heist'] = {
		title = "Heist Equipment Crafting",
		objects = {},
		locations = { vector3(-566.59, -1625.49, 28.51), }, -- BOXZONE: If you add one of these objects (locations = ...) it will spawn boxzones
		--spawnTable = { { coords = vector4(794.49, -2613.63, 87.97, 2.4), prop = 'ex_prop_ex_toolchest_01' } } -- SPAWNS TABLE: the spawnTable field holds a list of several tables with prop and location. If these are added it will SPAWN a table that's interactable
	},
	['guns'] = {
...
-- { -- SET THIS TO Config.BlueprintDudes = nil TO DISABLE
-- 	{
-- 		model = 'cs_nigel',
