...
function CreatePeds()
    ...
    for k=1, #Config.peds do
        ...
        if not Config.peds[k].createAccounts then exports.ox_target:addSphereZone({radius = 2.0, coords = vector3(coords.x, coords.y, coords.z-1), options = targetOpts}) return end
        print(vector3(coords.x, coords.y, coords.z-1))
        ...
        print(vector3(coords.x, coords.y, coords.z-1))
        exports.ox_target:addSphereZone({radius = 2.0, coords = vector3(coords.x, coords.y, coords.z-1), options=  targetOpts})
    end
    pedSpawned = true
end
