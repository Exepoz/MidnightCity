...
Shared.Time = 1 -- Minutes it takes to get a job upon interacting with the ped.
Shared.ClearMails = true -- Clears old Chop shop mails when starting the script.
Shared.MailAuthor = 'Mr. P' -- The senders name for the email.
Shared.MailTitle = 'Chop Shop' -- The title for the email
Shared.FuelScript = 'cdn-fuel' -- Resourcename of your fuel script, lj-fuel, LegacyFuel, qb-fuel, ...
...
Shared.Locations = { -- You can always add more vector4 coordinates
    ...
    --vector4(-619.52, -1604.56, 26.05, 175.22), Midnight Compound
...
Shared.DropOffLocations = { -- You can always add more vector3 coordinates
    ...
    -- vector3(2061.17, 3185.65, 44.19), -- small sandy
    -- vector3(2046.07, 3196.2, 44.19), -- small sandy

    vector3(1214.23, 1902.32, 77.87),
    vector3(1215.97, 1899.67, 77.86),
    vector3(1222.46, 1874.29, 78.92),
