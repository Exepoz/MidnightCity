...
Config.DurabilityMultiplier = {
    ...
    weapon_raypistol             = 0.25,
    weapon_ceramicpistol         = 0.25,
    weapon_navyrevolver          = 0.25,
    weapon_gadgetpistol          = 0.25,
    weapon_pistolxm3             = 0.25,
    ...
    weapon_minismg               = 0.35,
    weapon_raycarbine            = 0.35,

    -- Shotguns
    weapon_pumpshotgun           = 0.35,
    weapon_sawnoffshotgun        = 0.35,
    weapon_assaultshotgun        = 0.35,
    weapon_bullpupshotgun        = 0.35,
    weapon_musket                = 0.35,
    weapon_heavyshotgun          = 0.35,
    weapon_dbshotgun             = 0.35,
    weapon_autoshotgun           = 0.35,
    weapon_pumpshotgun_mk2       = 0.35,
    weapon_combatshotgun         = 0.35,

    -- Assault Rifles
    weapon_assaultrifle          = 0.45,
    weapon_assaultrifle_mk2      = 0.45,
    weapon_carbinerifle          = 0.45,
    weapon_carbinerifle_mk2      = 0.45,
    weapon_advancedrifle         = 0.45,
    weapon_specialcarbine        = 0.45,
    weapon_bullpuprifle          = 0.45,
    weapon_compactrifle          = 0.45,
    weapon_specialcarbine_mk2    = 0.45,
    weapon_bullpuprifle_mk2      = 0.45,
    weapon_militaryrifle         = 0.45,
    ...
    ['weapon_shiv'] 	             = 0.25,
    ['weapon_katana'] 	             = 0.15,
    ['weapon_sledgehammer'] 	     = 0.25,
    ['weapon_perforator'] 		     = 0.35,
    ----custom csknife
    ['weapon_bluebfknife'] 			 = 0.15,
    ['weapon_bfknife'] 				 = 0.25,
    ['weapon_chbfknife'] 			 = 0.15,
    ['weapon_crimsonbfknife'] 		 = 0.15,
    ['weapon_fadebfknife'] 			 = 0.25,
    ['weapon_flipknife'] 			 = 0.25,
    ['weapon_forestbfknife'] 		 = 0.15,
    ['weapon_gutknife'] 			 = 0.25,
    ['weapon_huntsmanknife'] 		 = 0.25,
    ['weapon_karambitknife'] 		 = 0.15,
    ['weapon_safaribfknife'] 		 = 0.15,
    ['weapon_scorchedbfknife'] 		 = 0.15,
    ['weapon_slaughterbfknife'] 	 = 0.15,
    ['weapon_stainebfknife'] 		 = 0.15,
    ['weapon_urbanrbfknife'] 		 = 0.15,
}
