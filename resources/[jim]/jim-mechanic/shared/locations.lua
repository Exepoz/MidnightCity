...
Config.Locations[#Config.Locations+1] = { --[[ RFC LS CUSTOMS ]]--
    ...
    clockin     = {
        ...
        { coords = vec4(-350.0, -150.9, 38.81, 160.92), prop = false, },
...
Config.Locations[#Config.Locations+1] = { --[[ Criinal HUB]]--
	CriminalHub = true,
    Enabled = true,
    job = "mechanic",
    zones = {
		vector2(-588.50, -1628.50),
		vector2(-566.77, -1630.18),
		vector2(-566.23, -1624.75),
		vector2(-558.96, -1624.54),
		vector2(-558.55, -1620.26),
		vector2(-566.32, -1619.20),
		vector2(-565.39, -1615.50),
		vector2(-587.06, -1613.38),
    },
...
--	autoClock = { enter = true, exit = true, },
--	stash = {
--		{ coords = vec4(-226.48, -1316.17, 31.27, 0.0), w = 2, d = 0.8, },
--	},
--	store = {
--		{ coords = vec4(-228.64, -1314.19, 31.3, 90.0), w = 2, d = 0.8 },
--	},
--	crafting = {
--		{ coords = vec4(-214.82, -1339.74, 31.46, 90.0), w = 2, d = 0.8 },
--	},
--	clockin = {
...
--    stash = {
--        { coords = vec4(-317.13, -138.4, 38.92, 70.45), w = 2.0, d = 3.0, },
--        { coords = vec4(-321.47, -149.53, 38.9, 70.45), w = 2.0, d = 3.0, },
--    },
--    store = {
--        --{ coords = vec4(-347.9, -133.19, 39.01, 340.0), w = 1.2, d = 0.25, },
--    },
...
--    },
--    clockin = {
--        { coords = vec4(-350.76, -129.75, 38.7, 70), prop = false },
--    },
--    manualRepair = {
...
--        { coords = vec4(-346.59, -131.73, 39.09, 249.5), prop = false, },
--    },
--    Restrictions = {
--        Vehicle = { "Compacts", "Sedans", "SUVs", "Coupes", "Muscle", "Sports Classics", "Sports", "Super", "Motorcycles", "Off-road", "Industrial", "Utility", "Vans", "Cycles", "Service", "Emergency", "Commercial", },
--        Allow = { "tools", "cosmetics", "repairs", "nos", "perform" },
