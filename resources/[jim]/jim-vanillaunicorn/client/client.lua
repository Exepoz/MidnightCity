			...
			if v.MLO == "gabz" then
				CreateThread(function()
					...
					Targets["UniFridge"] =
						exports['qb-target']:AddBoxZone("UniFridge", vec3(129.95, -1280.65, 29.27-1), 1.5, 0.6, { name="UniFridge", heading = 30.0, debugPoly=Config.Debug, minZ=28.22, maxZ=29.22 },
							{ options = { {  event = "jim-vanillaunicorn:Stash", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"], stash = "UniDrinkfrige1",  job = v.job }, }, distance = 1.5 })
					Targets["UniFridge2"] =
						exports['qb-target']:AddBoxZone("UniFridge2", vec3(128.84, -1284.25, 29.27-1), 1.5, 0.6, { name="UniFridge2", heading = 30.0, debugPoly=Config.Debug, minZ=28.27, maxZ=29.27 },
							{ options = { {  event = "jim-vanillaunicorn:Stash", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"], stash = "UniDrinkfrige2",  job = v.job }, }, distance = 1.5 })
					Targets["UniFridge3"] =
						exports['qb-target']:AddBoxZone("UniFridge3", vec3(129.74, -1285.53, 29.27-1), 0.8, 0.4, { name="UniFridge3", heading = 30.0, debugPoly=Config.Debug, minZ=28.27, maxZ=29.27 },
							{ options = { {  event = "jim-vanillaunicorn:Stash", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"], stash = "UniDrinkfrige3",  job = v.job }, }, distance = 1.5 })
					Targets["UniFridge4"] =
						exports['qb-target']:AddBoxZone("UniFridge4", vec3(132.66, -1285.43, 29.27-1), 1.2, 0.6, { name="UniFridge4", heading = 30.0, debugPoly=Config.Debug, minZ=28.27, maxZ=29.27 },
							{ options = { {  event = "jim-vanillaunicorn:Stash", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"], stash = "UniDrinkfrige4",  job = v.job }, }, distance = 1.5 })
					Targets["UniFridge5"] =
						exports['qb-target']:AddBoxZone("UniFridge5", vec3(119.23, -1302.93, 29.27-1), 1.4, 0.6, { name="UniFridge5", heading = 300.0, debugPoly=Config.Debug, minZ=28.27, maxZ=29.27 },
							{ options = { {  event = "jim-vanillaunicorn:Stash", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"], stash = "UniDrinkfrige5",  job = v.job }, }, distance = 1.5 })
					Targets["UniFridge6"] =
						exports['qb-target']:AddBoxZone("UniFridge6", vec3(132.32, -1291.67, 29.27-1), 0.8, 0.6, { name="UniFridge6", heading = 30.0, debugPoly=Config.Debug, minZ = 28.27, maxZ = 30.07, },
							{ options = { {  event = "jim-vanillaunicorn:Stash", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_food_fridge"], stash = "UniFoodfrige" , job = v.job }, }, distance = 2.0 })
					Targets["UniWash1"] =
				...
				elseif v.MLO == "fiv3devs" then
					CreateThread(function()
						...
						-- 		{ options = { {  event = "jim-vanillaunicorn:Stash", icon = "fas fa-box-open", label = "Prepared Food", stash = "UniStorage", job = v.job }, }, distance = 1.0 })
						Targets["UniFridge"] =
							exports['qb-target']:AddBoxZone("UniFridge", vec3(110.7, -1284.3, 29.05), 3.15, 0.55, { name="UniFridge", heading = 300.0, debugPoly=Config.Debug, minZ=28.65, maxZ=29.45 },
								{ options = { {  event = "jim-vanillaunicorn:Stash", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"], stash = "UniDrinkfrige1",  job = v.job }, }, distance = 1.5 })
						Targets["UniFridge2"] =
							exports['qb-target']:AddBoxZone("UniFridge2", vec3(99.5, -1285.65, 29.7), 4.8, 0.85, { name="UniFridge2", heading = 30.0, debugPoly=Config.Debug, minZ=28.25, maxZ=31.1 },
								{ options = { {  event = "jim-vanillaunicorn:Stash", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_storage"], stash = "UniStorage",  job = v.job }, }, distance = 1.5 })
						Targets["UniFridge3"] =
							exports['qb-target']:AddBoxZone("UniFridge3", vec3(97.65, -1286.8, 29.7), 4.8, 0.85, { name="UniFridge3", heading = 30.0, debugPoly=Config.Debug, minZ=28.28, maxZ=31.1 },
								{ options = { {  event = "jim-vanillaunicorn:Stash", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_storage"], stash = "UniStorage2",  job = v.job }, }, distance = 1.5 })
						Targets["UniFridge4"] =
							exports['qb-target']:AddBoxZone("UniFridge4", vec3(132.66, -1285.43, 29.27-1), 1.2, 0.6, { name="UniFridge4", heading = 30.0, debugPoly=Config.Debug, minZ=28.27, maxZ=29.27 },
								{ options = { {  event = "jim-vanillaunicorn:Stash", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"], stash = "UniDrinkfrige4",  job = v.job }, }, distance = 1.5 })
						Targets["UniFridge5"] =
						...
						Targets["UniFridge6"] =
							exports['qb-target']:AddBoxZone("UniFridge6", vec3(132.32, -1291.67, 29.27-1), 0.8, 0.6, { name="UniFridge6", heading = 30.0, debugPoly=Config.Debug, minZ = 28.27, maxZ = 30.07, },
								{ options = { {  event = "jim-vanillaunicorn:Stash", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_food_fridge"], stash = "UniFoodfrige" , job = v.job }, }, distance = 2.0 })
						Targets["UniWash1"] =
							exports['qb-target']:AddBoxZone("UniWash1", vec3(107.55, -1283.15, 29.6), 0.85, 0.75, { name="UniWash1", heading = 30.0, debugPoly=Config.Debug, minZ = 29.2, maxZ = 29.85, },
								{ options = { { event = "jim-vanillaunicorn:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], job = v.job }, }, distance = 1.5	})
						Targets["UniWash2"] =
							exports['qb-target']:AddBoxZone("UniWash2", vec3(130.28, -1286.21, 29.27-1), 0.8, 0.6, { name="UniWash2", heading = 30.0, debugPoly=Config.Debug, minZ = 28.67, maxZ = 29.87, },
								{ options = { { event = "jim-vanillaunicorn:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], }, }, distance = 1.5 })
						Targets["UniCounter"] =
							exports['qb-target']:AddBoxZone("UniCounter", vec3(117.6, -1281.45, 29.7), 1.5, 0.8, { name="UniCounter", heading = 30.0, debugPoly=Config.Debug, minZ = 29.65, maxZ = 29.75, },
								{ options = { { event = "jim-vanillaunicorn:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_counter"], stash = "UniCounter" }, }, distance = 2.0 })
						Targets["UniCounter2"] =
							exports['qb-target']:AddBoxZone("UniCounter2", vec3(116.25, -1282.25, 29.7), 1.5, 0.8, { name="UniCounter2", heading = 30.0, debugPoly=Config.Debug, minZ = 29.65, maxZ = 29.75, },
								{ options = { { event = "jim-vanillaunicorn:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_counter"], stash = "UniCounter2" }, }, distance = 2.0 })
						Targets["UniCounter3"] =
							exports['qb-target']:AddBoxZone("UniCounter3", vec3(113.55, -1283.8, 29.7), 1.5, 0.8, { name="UniCounter3", heading = 30.0, debugPoly=Config.Debug, minZ = 29.65, maxZ = 29.75, },
								{ options = { { event = "jim-vanillaunicorn:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_counter"], stash = "UniCounter3" }, }, distance = 2.0 })
						Targets["UniCounter4"] =
							exports['qb-target']:AddBoxZone("UniCounter4", vec3(110.7, -1285.45, 29.7), 1.5, 0.8, { name="UniCounter4", heading = 30.0, debugPoly=Config.Debug, minZ = 29.65, maxZ = 29.75, },
								{ options = { { event = "jim-vanillaunicorn:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_counter"], stash = "UniCounter4" }, }, distance = 2.0 })
						Targets["UniReceipt"] =
							exports['qb-target']:AddBoxZone("UniReceipt", vec3(117.3, -1280.35, 29.7), 0.4, 0.6, { name="UniReceipt", heading = 30.0, debugPoly=Config.Debug, minZ = 29.55, maxZ = 29.8, },
								{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = v.job,
												img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/1/10/VanillaUnicorn-GTAV-Logo.png/ width=225px></p>"
												} }, distance = 2.0 })
						Targets["UniReceipt2"] =
						...
						Targets["UniCocktails"] =
							exports['qb-target']:AddBoxZone("UniCocktails", vec3(113.05, -1283.0, 29.75), 0.35, 1.5, { name="UniCocktails", heading = 30.0, debugPoly=Config.Debug, minZ=29.55, maxZ=29.9 },
								{ options = { { event = "jim-vanillaunicorn:Crafting", icon = "fas fa-cocktail", label = Loc[Config.Lan].targetinfo["prepare_cocktails"], job = v.job, craftable = Crafting.Cocktails, header = Loc[Config.Lan].menu["cocktail"] }, }, distance = 2.0 })
						Targets["UniTap"] =
							exports['qb-target']:AddBoxZone("UniTap", vec3(108.7, -1284.7, 29.8), 0.5, 0.5, { name="UniTap", heading = 30.0, debugPoly=Config.Debug, minZ = 29.55, maxZ = 30.1, },
								{ options = { { event = "jim-vanillaunicorn:Crafting", icon = "fas fa-beer", label = Loc[Config.Lan].targetinfo["pour_beer"], job = v.job, craftable = Crafting.Beer, header = Loc[Config.Lan].menu["beer"] }, }, distance = 1.5 })
						Targets["UniCoffee"] =
							exports['qb-target']:AddBoxZone("UniCoffee", vec3(109.3, -1285.45, 29.6), 0.25, 0.25, { name="UniCoffee", heading = 0.0, debugPoly=Config.Debug, minZ = 29.6, maxZ = 30.0, },
								{ options = { { event = "jim-vanillaunicorn:JustGive", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["pour_coffee"], job = v.job, id = "coffee"}, }, distance = 2.0 })
						Targets["UniClockin"] =
							exports['qb-target']:AddBoxZone("UniClockin", vec3(98.95, -1298.8, 30.0), 0.8, 0.3, { name="UniClockin", heading = 300.0, debugPoly=Config.Debug, minZ = 29.35, maxZ = 30.65, },
								{ options = { { type = "server", event = "QBCore:ToggleDuty", icon = "fas fa-user-check", label = Loc[Config.Lan].targetinfo["toggle_duty"], job = v.job }, }, distance = 2.0 })
						Targets["UniBoss"] =
							exports['qb-target']:AddBoxZone("UniBoss", vec3(99.7, -1298.2, 35.65), 0.6, 0.75, { name="UniBoss", heading = 45.0, debugPoly=Config.Debug, minZ = 35.35, maxZ = 35.95, },
								{ options = { { event = "qb-bossmenu:client:OpenMenu", icon = "fas fa-list", label = Loc[Config.Lan].targetinfo["open_bossmenu"], job = bossroles, }, }, distance = 2.0 })
						Targets["UniBoss2"] =
							exports['qb-target']:AddBoxZone("UniBoss2", vec3(116.95, -1279.75, 29.9), 0.45, 0.8, { name="UniBoss2", heading = 30.0, debugPoly=Config.Debug, minZ = 29.55, maxZ = 30.15, },
								{ options = { { event = "qb-bossmenu:client:OpenMenu", icon = "fas fa-list", label = Loc[Config.Lan].targetinfo["open_bossmenu"], job = bossroles, }, }, distance = 2.0 })
						-- Targets["UniOven"] =
						-- 	exports['qb-target']:AddBoxZone("UniOven", vec3(134.24, -1290.51, 29.27-1), 0.6, 0.5, { name="UniOven", heading = 300.0, debugPoly=Config.Debug, minZ = 28.97, maxZ = 30.07, },
						-- 		{ options = { { event = "jim-vanillaunicorn:Crafting", icon = "fas fa-temperature-high", label = Loc[Config.Lan].targetinfo["use_oven"], job = v.job, craftable = Crafting.Food, header = Loc[Config.Lan].menu["oven"] }, }, distance = 2.0 })
						--Urinals--
						Targets["VUUrinal1"] =
							exports['qb-target']:AddBoxZone("VUUrinal1", vec3(128.7, -1272.4, 22.4), 0.5, 0.5, { name="VUUrinal1", heading = 30.0, debugPoly=Config.Debug, minZ = 21.9, maxZ = 22.85, },
								{ options = { { event = "jim-vanillaunicorn:useUrinal", icon = "fas fa-toilet", label = "Use Toilet",},}, distance = 2.0})
						Targets["VUUrinal2"] =
							exports['qb-target']:AddBoxZone("VUUrinal2", vec3(128.2, -1271.55, 22.4), 0.5, 0.5, { name="VUUrinal2", heading = 30.0, debugPoly=Config.Debug, minZ = 21.9, maxZ = 22.85, },
								{ options = { { event = "jim-vanillaunicorn:useUrinal", icon = "fas fa-toilet", label = "Use Toilet",},}, distance = 2.0})
						Targets["VUUrinal3"] =
							exports['qb-target']:AddBoxZone("VUUrinal3", vec3(127.7, -1270.65, 22.4), 0.5, 0.5, { name="VUUrinal3", heading = 30.0, debugPoly=Config.Debug, minZ = 21.9, maxZ = 22.85, },
								{ options = { { event = "jim-vanillaunicorn:useUrinal", icon = "fas fa-toilet", label = "Use Toilet",},}, distance = 2.0})
						...
						-- Prop Changes --
						-- local proptable = {
						-- 	{ prop = "prop_coffee_mac_02", coords = vec4(109.3, -1285.45, 29.6, 0.0) }, --{ prop = "prop_trailr_fridge", coords = vec4(132.14, -1291.79, 29.27, 120.0) },
						-- }
						-- for _, prop in pairs(proptable) do Props[#Props+1] = makeProp(prop, true, false) end
						-- Wait(5000)
						-- CreateModelHide(vec3(132.86, -1288.0, 29.27), 0.2, 1695461688, true)
				...
				CreateThread(function()
					...
					Targets["UniFridge"] =
						exports['qb-target']:AddBoxZone("UniFridge", vec3(128.89, -1284.18, 29.28), 3.8, 0.5, { name="UniFridge", heading = 30.0, debugPoly=Config.Debug, minZ=28.28, maxZ=29.27 },
							{ options = { {  event = "jim-vanillaunicorn:Stash", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"],"Open Fridge", job = v.job, shop = Config.DrinkItems, stash = "UniDrinkfrige1" }, }, distance = 1.5 })
					Targets["UniFridge2"] =
						exports['qb-target']:AddBoxZone("UniFridge2", vec3(129.72, -1280.61, 29.27), 2.85, 0.5, { name="UniFridge2", heading = 30.0, debugPoly=Config.Debug, minZ=28.27, maxZ=29.27 },
							{ options = { {  event = "jim-vanillaunicorn:Stash", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"],"Open Fridge", job = v.job, shop = Config.DrinkItems, stash = "UniDrinkfrige2" }, }, distance = 1.5 })
					Targets["UniFridge3"] =
						exports['qb-target']:AddBoxZone("UniFridge3", vec3(132.31, -1285.06, 29.27), 3.6, 0.5, { name="UniFridge3", heading = 30.0, debugPoly=Config.Debug, minZ=28.27, maxZ=29.27 },
							{ options = { {  event = "jim-vanillaunicorn:Stash", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"],"Open Fridge", job = v.job, shop = Config.DrinkItems, stash = "UniDrinkfrige3" }, }, distance = 1.5 })
					Targets["UniFridge4"] =
						exports['qb-target']:AddBoxZone("UniFridge4", vec3(129.35, -1279.92, 29.27), 0.75, 0.6, { name="UniFridge4", heading = 50.0, debugPoly=Config.Debug, minZ = 29.47, maxZ = 30.47, },
							{ options = { {  event = "jim-vanillaunicorn:Stash", icon = "fas fa-archive", label = "Open Food Fridge", job = v.job, shop = Config.FoodItems, stash = "UniFoodfrige" }, }, distance = 2.0 })
				...
				--Shops--
					Targets["GabzBMFridge"] =
						exports['qb-target']:AddBoxZone("GabzBMFridge", vec3(-1404.13, -598.73, 30.32-1), 1.4, 0.6, { name="GabzBMFridge", heading = 303.0, debugPoly=Config.Debug, minZ=29.32, maxZ=30.32 },
							{ options = { {  event = "jim-vanillaunicorn:Stash", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"], stash = "Drink Fridge", job = v.job, shop = Config.DrinkItems,}, }, distance = 1.5 })
					...
					Targets["GabzBMFridge2"] =
						exports['qb-target']:AddBoxZone("GabzBMFridge2", vec3(-1401.9, -597.28, 30.32-1), 1.4, 0.6, { name="GabzBMFridge2", heading = 303.0, debugPoly=Config.Debug, minZ=29.32, maxZ=30.32 },
							{ options = { {  event = "jim-vanillaunicorn:Stash", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_food_fridge"],"Open Food Fridge", stash = "Food Fridge", job = v.job, shop = Config.FoodItems,}, }, distance = 2.0 })
...
RegisterNetEvent('jim-vanillaunicorn:useUrinal', function(data)
	...
	if Config.ProgressBar == "ox" then
		if exports.ox_lib:progressBar({ duration = 5000, label = "Taking a whiz...", useWhileDead = false, canCancel = true, disable = { combat = true },}) then
			TriggerServerEvent("jim-vanillaunicorn:server:Urinal")
		else triggerNotify(nil, Loc[Config.Lan].error["cancelled"], 'error') end
	else
		QBCore.Functions.Progressbar('using_urinal', "Taking a whiz...",  math.random(6000, 9000), false, false, { disableMovement = true, disableCarMovement = true, disableMouse = false, disableCombat = true, },
...
RegisterNetEvent('jim-vanillaunicorn:usePotty', function(data)
	...
	if Config.ProgressBar == "ox" then
		...
		QBCore.Functions.Progressbar('using_urinal', "Taking a whiz...",  math.random(6000, 9000), false, false, { disableMovement = true, disableCarMovement = true, disableMouse = false, disableCombat = true, }, {}, {}, {}, function()
			TriggerServerEvent("jim-vanillaunicorn:server:Potty")
			--triggerNotify(nil, Loc[Config.Lan].success["have_washed_hands"], 'success')
		end, function()
			TriggerEvent('inventory:client:busy:status', false)
...
RegisterNetEvent('jim-vanillaunicorn:washHands', function(data)
	...
	if Config.ProgressBar == "ox" then
		if exports.ox_lib:progressBar({ duration = 5000, label = Loc[Config.Lan].progressbar["washing_hands"], useWhileDead = false, canCancel = true, anim = { dict = "mp_arresting",	clip = "a_uncuff", flag = 8 }, disable = { combat = true },}) then
			triggerNotify(nil, Loc[Config.Lan].success["have_washed_hands"], "success")
		else TriggerEvent('inventory:client:busy:status', false) end
	else
		QBCore.Functions.Progressbar('washing_hands', Loc[Config.Lan].progressbar["washing_hands"], math.random(6000, 8000), false, false, {
...
RegisterNetEvent('jim-vanillaunicorn:Crafting:MakeItem', function(data)
	...
	if Config.ProgressBar == "ox" then
		if exports.ox_lib:progressBar({ duration = bartime, label = bartext..QBCore.Shared.Items[data.item].label, useWhileDead = false, canCancel = true,
			anim = { dict = animDictNow, clip = animNow, flag = 8 },disable = { combat = true },}) then
				TriggerServerEvent('jim-vanillaunicorn:Crafting:GetItem', data.item, data.craft) Wait(500) TriggerEvent("jim-vanillaunicorn:Crafting", data)  else TriggerEvent('inventory:client:busy:status', false)
		end
	else
...
function FoodProgress(ItemMake, craftable)
	if Config.ProgressBar == "ox" then
		if exports.ox_lib:progressBar({ duration = 3000, label = Loc[Config.Lan].progress["pouring"]..QBCore.Shared.Items[ItemMake].label, useWhileDead = false, canCancel = true,
			anim = { dict = "mp_ped_interaction", clip = "handshake_guy_a", flag = 8 },disable = { combat = true },}) then
			TriggerServerEvent('jim-vanillaunicorn:Crafting:GetItem', ItemMake, craftable) else TriggerEvent('inventory:client:busy:status', false)
		end
	else
