...
RegisterServerEvent('md-drugs:server:makebutter', function()
  ...
  for k, v in pairs (recipe) do 
	...
	TriggerClientEvent('QBCore:Notify', src, "Grind Your Shit and Grab Some Butter", "error")
end)
...
RegisterServerEvent('md-drugs:server:makebrownies', function()
  ...
  for k, v in pairs (recipe) do 
	...
	TriggerClientEvent('QBCore:Notify', src, "You Need Other Ingredients", "error")
end)
...
RegisterServerEvent('md-drugs:server:makeoil', function()
  ...
  for k, v in pairs (recipe) do 
	...
	TriggerClientEvent('QBCore:Notify', src, "Grind your shit and grab Butane", "error")
end)
