...
Config.respawnTime = 1800 -- Seconds
...
------------- Cocaine -- 9050 ALONZO'S APPLIANCES --new animations require to be in a certain spot or they get fucky. uses bob74 ipl 
...
------------------------- LSD Locations -- GRAPESEED
Config.lysergicacid = vector3(1950.84, 5176.61, 48.4) -- get lysergic acid
Config.diethylamide = vector3(1955.38, 5183.97, 48.33) -- get diethylamide
Config.gettabs = vector3(1946.7, 5180.2, 47.98) -- buy tab paper
Config.buylsdlabkit = vector3(1958.40, 5184.27, 47.98)--  buy lab kit
...
------------------------- Heroin Locations ---- 10049 DOCKS

Config.dryplant = vector3(-324.29, -2443.3, 7.53) -- turn resin into powder
Config.buyheroinlabkit = vector3(-332.16, -2451.83, 7.36) -- buy heroin lab kit
Config.cutheroinone = vector3(-332.94, -2447.16, 7.16) -- cut heroin stage 1-3 with baking soda
Config.cutheroinone2 = vector3(-331.07, -2445.19, 7.16) -- cut heroin stage 1-3 with baking soda
Config.cutheroinone3 = vector3(-329.59, -2443.52, 7.16) -- cut heroin stage 1-3 with baking soda
Config.fillneedle = vector3(-327.29, -2440.99, 7.35) -- fill needles with heroin
Config.heroinlabkitprice = 10000 -- price of the lsd lab kit


------------ XTC --- NEAR OLD BARREL HEIST DOOR POST OP
...
----- mescaline ===== Same as Heroin
Config.DryOut = vector3(-324.29, -2443.3, 7.53) -- Place to dry out mescaline into usuable drug
Config.Badtrip = 20 -- number means % chance to spawn a clone that chases and attacks while on mescaline


-------------- lean
Config.SyrupVendor = vector3(346.69, -1388.99, 32.51) -- where the mission ped starts
Config.StartLoc = {
...
Config.MakeButter = vector3(1045.48, -3198.49, -39.17-1) -- where you make cannabutter and baked edibles
Config.MakeOil = vector3(1038.90, -3198.66, -39.17-1) -- where you make shatter
...
Config.AlertPoliceWholesale = 75 -- 1-100 of how often it will alert police
...
Config.Travellingmerchant = { ------------ these are the random locations the merchant can spawn on script start. whatever you want for the merchant is in Config.Items right below
	vector3(-229.75, 6451.99, 31.20), -- paleto
	vector3(1452.09, 6336.14, 23.69), -- 1001
	vector3(1707.81, 4930.72, 42.06), -- grapeseed gas
    vector3(-1381.84, -1325.77, 3.15), -- vesp beach
}
Config.Items = { --- this is the store for the travelling merchant
    label = "Travelling Merchant",
    slots = 24,
    items = {
        [1] =  {name = "tab_paper", 	    label = "Tab Paper", 		price = 500, 	amount = 50, 	info = {}, type = "item", slot = 1},
        [2] =  {name = "bakingsoda", 	    label = "Baking Soda",		price = 25, 	amount = 50, 	info = {}, type = "item", slot = 2},
		[3] =  {name = "empty_weed_bag",    label = "Empty Weed Bag", 	price = 20, 	amount = 100, 	info = {}, type = "item", slot = 3},
		[4] =  {name = "emptyvial",         label = "Empty Vial", 		price = 20, 	amount = 100, 	info = {}, type = "item", slot = 4},
		[5] =  {name = "needle", 		    label = "Syringe", 			price = 20,     amount = 100,	info = {}, type = "item", slot = 5},
		[6] =  {name = "cokeburner", 	    label = "Nokie Burner", 	price = 2500, 	amount = 50, 	info = {}, type = "item", slot = 6},
		[7] =  {name = "crackburner", 	    label = "Juke Burner",		price = 2500,   amount = 50, 	info = {}, type = "item", slot = 7},
		[8] =  {name = "lsdburner",		    label = "SideKick Burner",	price = 2500,   amount = 50, 	info = {}, type = "item", slot = 8},
		[9] =  {name = "heroinburner", 	    label = "Razr Burner",		price = 2500,   amount = 50, 	info = {}, type = "item", slot = 9},
		[10] = {name = "leancup", 		    label = "Empty Cup", 		price = 25, 	amount = 50, 	info = {}, type = "item", slot = 10},
        [11] = {name = "xtcburner", 	    label = "ENV Burner", 		price = 2500, 	amount = 50, 	info = {}, type = "item", slot = 11},
...
---------------------- Meth Config --- IPL
Config.MethTeleIn = vector3(173.56, 2779.27, 46.24) -- where you target to tele in
Config.MethTeleOut = vector3(996.91, -3200.83, -36.39) -- where you target to tele out
Config.MethHeistStart = vector3(-68.81, 6256.48, 31.09) -- where you get the mission to get ingridients
