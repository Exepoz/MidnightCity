...
Config.ItemsReward = {
    [1] = {item = "cash",                     	amt = {min = 450, max = 900}, probability = 1/15},
    [2] = {item = "pistol_ammo",            	amt = {min = 2, max = 5}, probability = 1/10},
    [3] = {item = "bandage",                 	amt = {min = 3, max = 6}, probability = 1/5},
    [4] = {item = "oxy",                     	amt = {min = 2, max = 3}, probability = 1/10},
    [5] = {item = "bluedream_joint",        	amt = {min = 1, max = 4}, probability = 1/5},
    [6] = {item = "bong",                     	amt = {min = 1, max = 1}, probability = 1/5},
    [7] = {item = "magicmushroom",             	amt = {min = 1, max = 4}, probability = 1/7},
    [8] = {item = "tablet",                 	amt = {min = 1, max = 1}, probability = 1/15},
    [9] = {item = "skunk_joint",         		amt = {min = 5, max = 12}, probability = 1/5},
    [10] = {item = "sourdiesel_joint",         	amt = {min = 3, max = 6}, probability = 1/5},
    [11] = {item = "lq_coke_seed",             	amt = {min = 2, max = 4}, probability = 1/50},
    [12] = {item = "10kgoldchain",             	amt = {min = 1, max = 1}, probability = 1/5},
    [13] = {item = "gold_bracelet",            	amt = {min = 1, max = 1}, probability = 1/5},
    [14] = {item = "armor",                 	amt = {min = 1, max = 2}, probability = 1/8},
    [15] = {item = "malmoheroin_syringe",     	amt = {min = 2, max = 5}, probability = 1/7},
    [16] = {item = "lockpick",                 	amt = {min = 1, max = 5}, probability = 1/5},
    [17] = {item = "weapon_switchblade",     	amt = {min = 1, max = 1}, probability = 1/10},
    [18] = {item = "lq_coke_baggy",         	amt = {min = 4, max = 10}, probability = 1/6},
    [19] = {item = "cash",                     	amt = {min = 150, max = 600}, probability = 1/5},
    [20] = {item = "romantic_book",            	amt = {min = 1, max = 1}, probability = 1/5},
    [21] = {item = "classic_phone",         	amt = {min = 1, max = 1}, probability = 1/5},
    [22] = {item = "malmo_skunk_seed",         	amt = {min = 1, max = 1}, probability = 1/3},
    [23] = {item = "samsungphone",             	amt = {min = 1, max = 1}, probability = 1/6},
    [24] = {item = "notepad",                	amt = {min = 1, max = 2}, probability = 1/5},
    [25] = {item = "watch",                 	amt = {min = 1, max = 1}, probability = 1/5},
    [26] = {item = "monitor",                 	amt = {min = 1, max = 1}, probability = 1/5},
    [27] = {item = "skull",                 	amt = {min = 1, max = 1}, probability = 1/5},
    [28] = {item = "book",                     	amt = {min = 1, max = 3}, probability = 1/5},
    [29] = {item = "pencil",                 	amt = {min = 1, max = 4}, probability = 1/5},
    ...
    [43] = {item = "cash",                     	amt = {min = 900, max = 1800}, probability = 1/40},
    [44] = {item = "poppy_seed",             	amt = {min = 1, max = 2},     probability = 1/35},
    [45] = {item = "burnerphone_wep",         	amt = {min = 1, max = 1}, probability = 1/50},
	[46] = {item = "gpu",         	amt = {min = 1, max = 1}, probability = 1/50},
	[47] = {item = "mainboard",         	amt = {min = 1, max = 1}, probability = 1/50},
...
Config.CompletionRewards = {
	{t = 'item', r = 'usb_fleeca'},
	{t = 'item', r = 'usb_fleeca'},
	{t = 'item', r = 'low_explosive'},
	{t = 'item', r = 'low_explosive'},
	{t = 'item', r = 'thermite'},
	{t = 'item', r = 'vpn'},
	{t = 'item', r = 'bobcat_codes'},
	{t = 'xp', r = 8},
	{t = 'xp', r = 10},
	{t = 'xp', r = 12},
}
...
Config.Lang = {
	...
	['getjob'] = 'Get a job',
	['waitcall'] = 'The crew is gonna find you a house, wait for their call.',
