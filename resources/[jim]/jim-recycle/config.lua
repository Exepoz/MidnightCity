...
Config = {
	...
	CloseHour = 17, -- From what hour should the pawnshop be closed?
	...
	Prices = {
		['copper'] = math.random(5,15),
		['plastic'] = math.random(2,7),
		['metalscrap'] = math.random(5,15),
		['steel'] = math.random(12,18),
		['glass'] = math.random(5,10),
		['iron'] = math.random(10,15),
		['rubber'] = math.random(5,15),
		['aluminum'] = math.random(5,15),
		['bottle'] = math.random(2,7),
		['can'] = math.random(2,7),
		['copperore'] = math.random(2,7),
		['goldore'] = math.random(18,25),
		['silverore'] = math.random(18,24),
		['ironore'] = math.random(5,10),
		['carbon'] =  math.random(5,10),
		['goldingot'] =  math.random(20,40),
		['silveringot'] =  math.random(20,40),
		['diamond_ring'] = math.random(30,40),
		['emerald_ring'] = math.random(30,45),
		['ruby_ring'] = math.random(30,50),
		['sapphire_ring'] = math.random(30,60),
		['diamond_ring_silver'] = math.random(40,70),
		['emerald_ring_silver'] = math.random(40,70),
		['ruby_ring_silver'] =math.random(40,70),
		['sapphire_ring_silver'] = math.random(40,70),
		['diamond_necklace'] = math.random(40,70),
		['emerald_necklace'] = math.random(40,70),
		['ruby_necklace'] = math.random(40,70),
		['sapphire_necklace'] = math.random(40,70),
		['diamond_necklace_silver'] = math.random(50,80),
		['emerald_necklace_silver'] =math.random( 50,80),
		['ruby_necklace_silver'] = math.random(50,80),
		['sapphire_necklace_silver'] = math.random(50,80),
		['diamond_earring'] = math.random(30,60),
		['emerald_earring'] = math.random(30,60),
		['ruby_earring'] = math.random(30,60),
		['sapphire_earring'] = math.random(30,60),
		['diamond_earring_silver'] =math.random(30,60),
		['emerald_earring_silver'] =math.random(30,60),
		['ruby_earring_silver'] = math.random(30,60),
		['sapphire_earring_silver'] = math.random(30,60),
		['gold_ring'] = math.random(60,80),
		['goldchain'] = math.random(80,90),
		['goldearring'] = math.random(70,75),
		['silver_ring'] = math.random(40,50),
		['silverchain'] = math.random(40,60),
		['silverearring'] = math.random(30,60),
	},
	BottleBankTable = {
		"bottle",
		"can",
