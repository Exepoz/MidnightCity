...
Config.ItemsReward = {
    ...
    [5] = {item = "gratefuldead_tabs",        	amt = {min = 1, max = 4}, probability = 1/5},
    [6] = {item = "bong",                     	amt = {min = 1, max = 1}, probability = 1/5},
    [8] = {item = "tablet",                 	amt = {min = 1, max = 1}, probability = 1/15},
    [9] = {item = "joint",         		amt = {min = 5, max = 12}, probability = 1/5},
    [10] = {item = "shrooms",         	amt = {min = 3, max = 6}, probability = 1/5},
    [12] = {item = "10kgoldchain",             	amt = {min = 1, max = 1}, probability = 1/5},
    [13] = {item = "goldbar",            	amt = {min = 1, max = 1}, probability = 1/5},
    ...
    [17] = {item = "weapon_switchblade",     	amt = {min = 1, max = 1}, probability = 1/10},
   	[18] = {item = "cokebaggystagetwo",         	amt = {min = 4, max = 10}, probability = 1/6},
    [19] = {item = "cash",                     	amt = {min = 150, max = 600}, probability = 1/5},
    [20] = {item = "weapontint_mk2_14",            	amt = {min = 1, max = 1}, probability = 1/5},
    [21] = {item = "phone",         	amt = {min = 1, max = 1}, probability = 1/5},
    [22] = {item = "tab_paper",         	amt = {min = 1, max = 1}, probability = 1/3},
    [23] = {item = "samsungphone",             	amt = {min = 1, max = 1}, probability = 1/6},
    [24] = {item = "monitor",                	amt = {min = 1, max = 2}, probability = 1/5},
    [25] = {item = "rolex",                 	amt = {min = 1, max = 1}, probability = 1/5},
    [26] = {item = "laptop",                 	amt = {min = 1, max = 1}, probability = 1/5},
    [27] = {item = "captainskull",                 	amt = {min = 1, max = 1}, probability = 1/5},
	...
	[50] = {item = "skull",         	amt = {min = 1, max = 1}, probability = 1/50},
