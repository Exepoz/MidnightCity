Config = {
	...
	CoreOptions = {
		Lan = "en",
		Menu = "qb", -- ox, qb, or jim-menu
		Notify = "qb", -- qb, t, rr, ox
		Inv = "qb", -- qb or ox
		...
		img = "lj-inventory/html/images/", -- lj-inventory/html/images/ change this to whatever your inventory is or leave blank if getting double images
	},
	BankingOptions = {
		RenewedBanking = true,
	},
	ScriptOptions = {
		...
		FarmingRep = true, -- turns on rep being given and requires rep for crafting
		FarmingRepNotifications = true, -- turns on rep notifications
