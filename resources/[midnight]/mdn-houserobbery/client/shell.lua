...
function HighEnd(entradaCoords)
	...
	local model = 'shell_highend'
	--local model = 'v_16_mesh_shell'
	local madeSafe = false
	local items = {}
	local obj = {}
	local x = 1
	DoScreenFadeOut(1000)
	Citizen.Wait(1500)
	TriggerEvent('qb-weathersync:client:DisableSync', {23, 0, 0})
	...
	RequestModel(GetHashKey(model))
	while not HasModelLoaded(GetHashKey(model)) do Citizen.Wait(5) end
	local building = CreateObject(GetHashKey(model),generator.x+3.62430500,generator.y-1.55553200,generator.z+0.0,false,true,false)
	...
	LoadModel('V_16_bed_mesh_delta')
	obj[#obj+1] = CreateObject('V_16_bed_mesh_delta',generator.x-1.76030900,generator.y-0.67466500,generator.z-0.0,false,false,false)
	obj[#obj+1] = CreateObject('V_16_bed_mesh_delta',generator.x-1.76030900,generator.y-0.67466500,generator.z+0.02,false,false,false)

	LoadModel('V_16_high_bed_over_normal')
	obj[#obj+1] = CreateObject('V_16_high_bed_over_normal',generator.x-1.75513100,generator.y+1.65130700,generator.z-0.0,false,false,false)

	LoadModel('V_16_bdrm_mesh_bath')
	obj[#obj+1] = CreateObject('V_16_bdrm_mesh_bath',generator.x+5.70348400,generator.y-0.86338900,generator.z+0.0,false,false,false)

	LoadModel('V_16_bdRm_paintings002')
	obj[#obj+1] = CreateObject('V_16_bdRm_paintings002',generator.x-0.41010200,generator.y-0.58682690,generator.z+0.15,false,false,false)

	LoadModel('V_16_high_bed_mesh_lights')
	obj[#obj+1] = CreateObject('V_16_high_bed_mesh_lights',generator.x+0.59020600,generator.y+2.21927200,generator.z-0.01,false,false,false)
	...
	--LoadModel('hei_int_heist_lnb_coffee')
	obj[#obj+1] = CreateObject('hei_int_heist_lnb_coffee',generator.x+0.55458700,generator.y-2.51553800,generator.z+0.0,false,false,false)

	LoadModel('V_16_high_bed_over_dirt')
	obj[#obj+1] = CreateObject('V_16_high_bed_over_dirt',generator.x+3.62430500,generator.y-1.55553200,generator.z+0.0,false,false,false)

	LoadModel('V_16_lng_mesh_stairGlass')
	obj[#obj+1] = CreateObject('V_16_lng_mesh_stairGlass',generator.x-7.56569000,generator.y-0.83904900,generator.z+5.030,false,false,false)

	LoadModel('V_16_lng_mesh_delta')
	obj[#obj+1] = CreateObject('V_16_lng_mesh_delta',generator.x-5.13722400,generator.y+0.09224100,generator.z+2.580,false,false,false)

	LoadModel('V_16_lng_over_normal')
	obj[#obj+1] = CreateObject('V_16_lng_over_normal',generator.x-1.36473800,generator.y+0.80418800,generator.z+2.580,false,false,false)

	LoadModel('V_16_lng_mesh_blinds')
	obj[#obj+1] = CreateObject('V_16_lng_mesh_blinds',generator.x+4.04209900,generator.y-0.44575400,generator.z+7.680,false,false,false)

	LoadModel('V_16_lng_mesh_windows')
	obj[#obj+1] = CreateObject('V_16_lng_mesh_windows',generator.x+4.13028000,generator.y-0.57411700,generator.z+4.800,false,false,false)

	LoadModel('V_16_high_lng_details')
	local bowl = CreateObject('V_16_high_lng_details',generator.x+8.45114900,generator.y-0.81883400,generator.z+5.390,false,false,false)
	-- obj[#obj+1] = CreateObject('V_16_high_lng_details',generator.x+8.45114900,generator.y-0.81883400,generator.z+5.390,false,false,false)
	table.insert(items,{object = bowl, robbed = false, anim = 'normal', deleteObj = true, dist = 2.00})


	LoadModel('V_16_lgb_mesh_lngProp')
	obj[#obj+1] = CreateObject('V_16_lgb_mesh_lngProp',generator.x+8.37186000,generator.y-1.07978700,generator.z+4.880,false,false,false)

	LoadModel('V_16_knt_c')
	obj[#obj+1] = CreateObject('V_16_knt_c',generator.x+6.42180800,generator.y-0.99209900,generator.z+4.810,false,false,false)

	LoadModel('V_16_rpt_mesh_pictures')
	obj[#obj+1] = CreateObject('V_16_rpt_mesh_pictures',generator.x-8.01097500,generator.y-2.66429500,generator.z+5.450,false,false,false)

	LoadModel('V_16_high_lng_mesh_delta')
	obj[#obj+1] = CreateObject('V_16_high_lng_mesh_delta',generator.x-9.39279700,generator.y+0.07170800,generator.z+2.380,false,false,false)

	--LoadModel('hei_int_heist_bed_unit')
	obj[#obj+1] = CreateObject('hei_int_heist_bed_unit',generator.x+3.64581600,generator.y+2.85395100,generator.z+0.0,false,false,false)

	LoadModel('V_16_high_lng_mesh_plant')
	obj[#obj+1] = CreateObject('V_16_high_lng_mesh_plant',generator.x-3.68126800,generator.y+4.03672500,generator.z+4.590,false,false,false)

	LoadModel('V_16_high_lng_mesh_tvUnit')
	obj[#obj+1] = CreateObject('V_16_high_lng_mesh_tvUnit',generator.x+9.03048800,generator.y-4.68231400,generator.z+4.900,false,false,false)
	...
	LoadModel('V_16_high_stp_mesh_unit')
	obj[#obj+1] = CreateObject('V_16_high_stp_mesh_unit',generator.x-13.39290000,generator.y-0.17506300,generator.z+2.35,false,false,false)

	LoadModel('v_16_v_sofa')
	obj[#obj+1] = CreateObject('v_16_v_sofa',generator.x+7.80983000,generator.y+0.06534800,generator.z+4.85,false,false,false)

	LoadModel('V_16_lng_mesh_stairGlassB')
	obj[#obj+1] = CreateObject('V_16_lng_mesh_stairGlassB',generator.x-9.96113500,generator.y-2.60950900,generator.z+6.39,false,false,false)

	LoadModel('V_16_dnr_a')
	obj[#obj+1] = CreateObject('V_16_dnr_a',generator.x+9.33427000,generator.y+12.73493000,generator.z+6.25,false,false,false)

	LoadModel('V_16_high_ktn_over_decal')
	obj[#obj+1] = CreateObject('V_16_high_ktn_over_decal',generator.x+1.23671000,generator.y+8.76967200,generator.z+4.82,false,false,false)

	LoadModel('V_16_high_ktn_over_shadow')
	obj[#obj+1] = CreateObject('V_16_high_ktn_over_shadow',generator.x+9.23939100,generator.y+12.44786000,generator.z+4.82,false,false,false)

	LoadModel('V_16_high_kit_mesh_unit')
	obj[#obj+1] = CreateObject('V_16_high_kit_mesh_unit',generator.x-1.81104800,generator.y+9.17513200,generator.z+4.82,false,false,false)

	LoadModel('V_16_lnb_mesh_tableCenter001')
	obj[#obj+1] = CreateObject('V_16_lnb_mesh_tableCenter001',generator.x+9.90664500,generator.y+6.71798600,generator.z+5.7,false,false,false)

	LoadModel('V_16_high_ktn_mesh_delta')
	obj[#obj+1] = CreateObject('V_16_high_ktn_mesh_delta',generator.x+4.43419300,generator.y+9.17583700,generator.z+4.81,false,false,false)

	LoadModel('V_16_high_ktn_mesh_windows')
	obj[#obj+1] = CreateObject('V_16_high_ktn_mesh_windows',generator.x+4.12927300,generator.y+12.89458000,generator.z+4.81,false,false,false)

	LoadModel('V_16_high_ktn_mesh_fire')
	obj[#obj+1] = CreateObject('V_16_high_ktn_mesh_fire',generator.x+6.25015900,generator.y+5.34384200,generator.z+5.1,false,false,false)

	LoadModel('V_16_dnr_c')
	obj[#obj+1] = CreateObject('V_16_dnr_c',generator.x+9.99221000,generator.y+12.55397000,generator.z+4.84,false,false,false)

	LoadModel('V_16_lngAS_mesh_delta003')
	obj[#obj+1] = CreateObject('V_16_lngAS_mesh_delta003',generator.x+0.69565000,generator.y+13.05990000,generator.z+4.84,false,false,false)

	LoadModel('V_16_hiigh_ktn_over_normal')
	obj[#obj+1] = CreateObject('V_16_hiigh_ktn_over_normal',generator.x+3.76106900,generator.y+9.03640600,generator.z+4.84,false,false,false)
	LoadModel('V_16_high_hall_mesh_delta')
	obj[#obj+1] = CreateObject('V_16_high_hall_mesh_delta',generator.x-18.46974000,generator.y-0.07385800,generator.z+6.2,false,false,false)
	LoadModel('V_16_high_hall_over_normal')
	obj[#obj+1] = CreateObject('V_16_high_hall_over_normal',generator.x-18.30516000,generator.y+1.78606500,generator.z+6.2,false,false,false)
	LoadModel('V_16_high_hall_over_dirt')
	obj[#obj+1] = CreateObject('V_16_high_hall_over_dirt',generator.x-18.19183000,generator.y-0.05498100,generator.z+6.2,false,false,false)
	LoadModel('V_16_high_hall_over_shadow')
	obj[#obj+1] = CreateObject('V_16_high_hall_over_shadow',generator.x-16.98634000,generator.y-0.46674400,generator.z+6.2,false,false,false)
	LoadModel('V_16_high_hal_mesh_plant')
	obj[#obj+1] = CreateObject('V_16_high_hal_mesh_plant',generator.x-15.28974000,generator.y+4.79591600,generator.z+6.0,false,false,false)
	LoadModel('V_16_high_bath_mesh_mirror')
	obj[#obj+1] = CreateObject('V_16_high_bath_mesh_mirror',generator.x-4.29534100,generator.y+3.74431100,generator.z+1.2,false,false,false)
	LoadModel('V_16_high_bath_over_shadow')
	obj[#obj+1] = CreateObject('V_16_high_bath_over_shadow',generator.x-4.25607300,generator.y+6.22950200,generator.z+0.0,false,false,false)
	LoadModel('V_16_high_bath_over_normals')
	obj[#obj+1] = CreateObject('V_16_high_bath_over_normals',generator.x-4.32515600,generator.y+5.55146000,generator.z+0.0,false,false,false)
	LoadModel('V_16_high_bath_delta')
	obj[#obj+1] = CreateObject('V_16_high_bath_delta',generator.x-4.32213500,generator.y+6.22829300,generator.z+0.0,false,false,false)
	LoadModel('V_16_mags')
	obj[#obj+1] = CreateObject('V_16_mags',generator.x-10.44022000,generator.y+8.14852500,generator.z+6.23,false,false,false)
	--LoadModel('V_16_HIFI')
	--obj[#obj+1] = CreateObject('V_16_HIFI',generator.x-10.23440000,generator.y+8.07973100,generator.z+6.23,false,false,false)
	--LoadModel('V_16_goldRecords')
	--obj[#obj+1] = CreateObject('V_16_goldRecords',generator.x-6.60447500,generator.y+8.12033200,generator.z+7.6,false,false,false)
	--LoadModel('V_16_BasketBall')
	--obj[#obj+1] = CreateObject('V_16_BasketBall',generator.x-9.66279400,generator.y+5.33664100,generator.z+7.0,false,false,false)
	--LoadModel('V_16_study_rug')
	--obj[#obj+1] = CreateObject('V_16_study_rug',generator.x-10.4173000,generator.y+8.21256100,generator.z+6.23,false,false,false)
	--LoadModel('V_16_study_sofa')
	--obj[#obj+1] = CreateObject('V_16_study_sofa',generator.x-8.57377800,generator.y+6.95918400,generator.z+6.23,false,false,false)
	--LoadModel('V_16_hi_apt_S_Books')
	--obj[#obj+1] = CreateObject('V_16_hi_apt_S_Books',generator.x-10.46981000,generator.y+7.54295200,generator.z+6.62,false,false,false)
	LoadModel('V_16_Wardrobe')
	local wardrobe = CreateObject('V_16_Wardrobe',generator.x+4.04197800,generator.y+6.41092600,generator.z+0.0,false,false,false)
	--obj[#obj+1] = CreateObject('V_16_Wardrobe',generator.x+4.04197800,generator.y+6.41092600,generator.z+0.0,false,false,false)
	table.insert(items,{object = wardrobe, robbed = false, anim = 'search', deleteObj = false, dist = 1.50})


	LoadModel('V_16_high_ward_over_decal')
	obj[#obj+1] = CreateObject('V_16_high_ward_over_decal',generator.x+3.53625300,generator.y+6.29680900,generator.z+0.0,false,false,false)
	LoadModel('V_16_high_ward_over_shadow')
	obj[#obj+1] = CreateObject('V_16_high_ward_over_shadow',generator.x+3.89552500,generator.y+6.29853200,generator.z+0.0,false,false,false)
	LoadModel('V_16_high_ward_over_normal')
	obj[#obj+1] = CreateObject('V_16_high_ward_over_normal',generator.x+3.70096300,generator.y+6.29901000,generator.z+0.0,false,false,false)
	LoadModel('v_res_fh_benchshort')
	...
	LoadModel('V_ILev_MP_high_FrontDoor')
	...
	LoadModel('v_res_fh_lampa_on')
	local lamp = CreateObject('v_res_fh_lampa_on',generator.x+5.86731700,generator.y-2.72296000,generator.z+0.5,true,false,false)
	table.insert(items,{object = lamp, robbed = false, anim = 'mesa', deleteObj = false, dist = 1.00})

	LoadModel('v_res_fh_easychair')
	...
	table.insert(items,{object = table2, robbed = false, anim = 'mesa', deleteObj = true, dist = 1.3})

	LoadModel('Prop_T_Telescope_01b')
	...
	table.insert(items,{object = scope, robbed = false, anim = 'telescope', deleteObj = true, dist = 1.30})

	LoadModel('v_res_mplanttongue')
	...
	LoadModel('v_res_fh_sidebrddine')
	...
	table.insert(items,{object = table3, robbed = false, anim = 'normal', deleteObj = false, dist = 1.50})

	LoadModel('as_prop_as_speakerdock')
	...
	table.insert(items,{object = radio1, robbed = false, anim = 'normal', deleteObj = true, dist = 1.40})

	LoadModel('as_prop_as_speakerdock')
	local radio2 = CreateObject('as_prop_as_speakerdock',generator.x+3.64,generator.y+2.943,generator.z+1.00,true,false,false)
	table.insert(items,{object = radio2, robbed = false, anim = 'normal', deleteObj = true, dist = 1.40})

	LoadModel('prop_kitch_juicer')
	local jugos = CreateObject('prop_kitch_juicer',generator.x-4.688541,generator.y+6.830099,generator.z+5.80,true,false,false)
	table.insert(items,{object = jugos, robbed = false, anim = 'normal', deleteObj = true, dist = 1.40})

	LoadModel('prop_micro_02')
	local microwave = CreateObject('prop_micro_02',generator.x-0.47,generator.y+6.83,generator.z+5.85,true,false,false)
	table.insert(items,{object = microwave, robbed = false, anim = 'prop_micro_02', deleteObj = true, dist = 1.20})

	LoadModel('v_res_fh_diningtable')
	...
	--LoadModel('hei_int_heist_rpt_pictures3')
	local painting = CreateObject('hei_int_heist_rpt_pictures3',generator.x+12.47420000,generator.y+6.88947700,generator.z+5.76,true,false,false)
	table.insert(items,{object = painting, robbed = false, anim = 'painting', deleteObj = true, dist = 1.60})

	LoadModel('V_16_high_ktn_over_shadows')
	...
	obj[#obj+1] = kitchenShadow

	LoadModel('V_16_knt_mesh_stuff')
	...
	obj[#obj+1] = kitchenStuff

	--LoadModel('hei_int_heist_lng_armchairs')
	...
	--LoadModel('hei_int_heist_fh_sidebrdlngb')
	...
	table.insert(items,{object = mesa, robbed = false, anim = 'normal', deleteObj = false, dist = 1.5})

	--LoadModel('hei_int_heist_lng_shelf')
	...
	table.insert(items,{object = librero, robbed = false, anim = 'normal', deleteObj = false, dist = 1.3})
	...
	SetEntityHeading(microwave,GetEntityHeading(microwave)+180)
...
function MidApt(entradaCoords)
	...
	RequestModel(GetHashKey(model))
	while not HasModelLoaded(GetHashKey(model)) do Citizen.Wait(5) end
	local building = CreateObject(GetHashKey(model), generator.x+2.30,generator.y-1.35553200,generator.z+1.16253700,false,true,false)
	while not DoesEntityExist(building) do Citizen.Wait(50) end
	FreezeEntityPosition(building,true)
	Citizen.Wait(2000)
	...
	LoadModel('V_16_mid_hall_mesh_delta')
	...
	LoadModel('V_16_MID_bed_over_decal')
	...
	LoadModel('V_16_mid_bath_mesh_mirror')
--	local bathDelta = CreateObject(GetHashKey("V_16_mid_bath_mesh_delta"), generator.x+4.45460500, generator.y+3.21322800, generator.z+1.21116100, false, false, false)
	...
	table.insert(items,{object = micro, robbed = false, anim = 'prop_micro_01', deleteObj = true, dist = 1.10})
	...
	table.insert(items,{object = sideBoard, robbed = false, anim = 'normal', deleteObj = false, dist = 1.3})
	--obj[#obj+1] = sideBoard
	x = x + 1
	...
	table.insert(items,{object = bedSide, robbed = false, anim = 'normal', deleteObj = false, dist = 1.5})
	...
	table.insert(items,{object = tv, robbed = false, anim = 'tv', deleteObj = true, dist = 1.20})
	...
	table.insert(items,{object = storage, robbed = false, anim = 'normal', deleteObj = false, dist = 1.50})
	...
	table.insert(items,{object = storage2, robbed = false, anim = 'normal', deleteObj = false, dist = 1.50})
	...
	table.insert(items,{object = wardrobe, robbed = false, anim = 'normal', deleteObj = false, dist = 1.8})
	...
	table.insert(items,{object = tapeplayer, robbed = false, anim = 'Prop_Tapeplayer_01', deleteObj = false, dist = 1.2})
	--obj[#obj+1] = tapeplayer
	x = x + 1
