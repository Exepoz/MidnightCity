...
* **Determine which resource the problem should be reported in**. If the bug is related to the inventory for example report this bug under ps-inventory rather than under qb-core or some other resource.
