...
SellItems = {
    ['orange'] = { price = math.random(2, 5), category = "FRUIT" },
    ['apple'] = { price = math.random(2,5), category = "FRUIT" },
    ['pear'] = { price = math.random(2,5), category = "FRUIT" },
    ['lemon'] = { price = math.random(2,5), category = "FRUIT" },
    ['mango'] = { price = math.random(2,5), category = "FRUIT" },
    ['peach'] = { price = math.random(2,5), category = "FRUIT" },
    ['plum'] = { price = math.random(2,5), category = "FRUIT" },
    ['cherry'] = { price = math.random(2,5), category = "FRUIT" },
    ['blueberry'] = { price = math.random(2,5), category = "FRUIT" },
    ['blackberry'] = { price = math.random(2,5), category = "FRUIT" },
    ['strawberry'] = { price = math.random(2,5), category = "FRUIT" },
    ['rasberry'] = { price = math.random(2,5), category = "FRUIT" },
    ['guava'] = { price = math.random(2,5), category = "FRUIT" },
    ['apricot'] = { price = math.random(2,5), category = "FRUIT" },
    ['papaya'] = { price = math.random(2,5), category = "FRUIT" },
    ['banana'] = { price = math.random(2,5), category = "FRUIT" },
    ['tomato'] = { price = math.random(2,5), category = "VEGETABLES" },
    ['avacado'] = { price = math.random(2,5), category = "VEGETABLES" },
    ['chilipepper'] = { price = math.random(2,5), category = "HERBS & PLANTS" },
    ['wheat'] = { price = math.random(2,5), category = "HERBS & PLANTS" },
    ['thyme'] = { price = math.random(2,5), category = "HERBS & PLANTS" },
    ['basil'] = { price = math.random(2,5), category = "HERBS & PLANTS" },
    ['mint'] = { price = math.random(2,5), category = "HERBS & PLANTS" },
    ['oregano'] = { price = math.random(2,5), category = "HERBS & PLANTS" },
    ['cilantro'] = { price = math.random(2,5), category = "HERBS & PLANTS" },
    ['chives'] = { price = math.random(2,5), category = "HERBS & PLANTS" },
    ['walnut'] = { price = math.random(2,5), category = "PROCESSED PRODUCTS" },
    ['almond'] = { price = math.random(2,5), category = "PROCESSED PRODUCTS" },
    ['pistachio'] = { price = math.random(2,5), category = "PROCESSED PRODUCTS" },
    ['orangejuice'] = { price = math.random(2,5), category = "PROCESSED PRODUCTS" },
    ['lemonjuice'] = { price = math.random(2,5), category = "PROCESSED PRODUCTS" },
    ['peachjuice'] = { price = math.random(2,5), category = "PROCESSED PRODUCTS" },
    ['applejuice'] = { price = math.random(2,5), category = "PROCESSED PRODUCTS" },
    ['tomatojuice'] = { price = math.random(2,5), category = "PROCESSED PRODUCTS" },
    ...
    ['fish'] = { price = math.random(13,15),        category = "WILD GAME" },
    ['stripedbass'] = { price = math.random(14,18), category = "WILD GAME" },
    ['bluefish'] = { price = math.random(15,19),    category = "WILD GAME" },
    ['redfish'] = { price = math.random(16,22),     category = "WILD GAME" },
    ['goldfish'] = { price = math.random(19,25),    category = "WILD GAME" },
    ['largemouthbass'] = { price = math.random(22,23), category = "WILD GAME" },
