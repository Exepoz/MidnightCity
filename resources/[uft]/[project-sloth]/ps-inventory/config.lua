...
Config.CraftingObject = nil -- Only needed if not using target | Line 928 to change Target Models
...
Config.AttachmentCraftingLocation = vector3(-795.94, 334.59, 230.64) -- Only needed if not using target
