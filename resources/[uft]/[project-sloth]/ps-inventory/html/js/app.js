...
function FormatItemInfo(itemData, dom) {
    ...
    if (itemData.type == "weapon") {
        ...
        if (itemData.info.attachments != null) {
            ...
            wInfo = "<p style=\"font-size:12px\"><strong>Serial: </strong><span>" +
            itemData.info.serie +
            "</span></p><p style=\"font-size:12px\"><strong>Ammo: </strong><span>" +
            itemData.info.ammo +
            "</span></p><p style=\"font-size:12px\"><strong>Attachments: </strong><span>" +
            attachmentString +
            "</span></p>"
    ...
    var content = $(".item-info-description").html();
    var ncontent = content + "<hr style=\"color:white;background-color:white;margin-bottom:0.3em;margin-top:0.4em\">" + wInfo + c + "<p style=\"font-size:11px\"><b>Weight: <a style=\"color:DeepSkyBlue\">" + itemData.weight/1000 + "p Each </a><b>| Amount: <a style=\"color:DeepSkyBlue\">" + itemData.amount + "</a>" + qstr + "</b></p>"
    $(".item-info-description").html(ncontent);
}
...
function optionSwitch(
    ...
    var ItemLabel = '</p></div><div class="item-slot-label"><p>' + fromData.label + "</p></div>"
    if (fromData.name == "orderbox") {
        ItemLabel = '<div class="item-slot-label"><p>' + fromData.label + "</p><p style =\"font-size:12px;color:DeepSkyBlue\">(" + fromData.info.itemName + ")</p></div>";
    } else if (fromData.name == "lootbag") {
        ItemLabel = '<div class="item-slot-label"><p>' + fromData.label + "</p><p style =\"font-size:12px;color:DeepSkyBlue\">(" + fromData.info.typeName + ")</p></div>";
    }
    ...
    var ItemLabel = '</p></div><div class="item-slot-label"><p>' + fromData.label + "</p></div>"
    if (toData.name == "orderbox") {
        ItemLabel = '<div class="item-slot-label"><p>' + toData.label + "</p><p style =\"font-size:12px;color:DeepSkyBlue\">(" + toData.info.itemName + ")</p></div>";
    } else if (toData.name == "lootbag") {
        ItemLabel = '<div class="item-slot-label"><p>' + toData.label + "</p><p style =\"font-size:12px;color:DeepSkyBlue\">(" + toata.info.typeName + ")</p></div>";
    }
        ...
        if (
            ...
            if (fromData.amount == $toAmount) {
                ...
                //     if (!Inventory.IsWeaponBlocked(newData.name)) {
                    ...
                    if (newData.name == "orderbox") {
                        ItemLabel = '<div class="item-slot-label"><p>' + newData.label + "</p><p style =\"font-size:12px;color:DeepSkyBlue\">(" + newData.info.itemName + ")</p></div>";
                    } else if (newData.name == "lootbag") {
                        ItemLabel = '<div class="item-slot-label"><p>' + newData.label + "</p><p style =\"font-size:12px;color:DeepSkyBlue\">(" + newData.info.typeName + ")</p></div>";
                    }
                    // }
                // }
                ...
                if ($fromInv.attr("data-inventory").split("-")[0] == "itemshop") {
                    ...
                    // if (newDataFrom.name.split("_")[0] == "weapon") {
                        // if (!Inventory.IsWeaponBlocked(newDataFrom.name)) {
                            if (newDataFrom.info.quality != 100) {
                            ItemLabel =
                                '<div class="item-slot-quality"><div class="item-slot-quality-bar"><p>100</p></div></div><div class="item-slot-label"><p>' +
                                newDataFrom.label +
                                "</p></div>";
                            ...
                            if (newDataFrom.name == "orderbox") {
                                ItemLabel = '<div class="item-slot-label"><p>' + newDataFrom.label + "</p><p style =\"font-size:12px;color:DeepSkyBlue\">(" + newDataFrom.info.itemName + ")</p></div>";
                            } else if (newDataFrom.name == "lootbag") {
                                ItemLabel = '<div class="item-slot-label"><p>' + newDataFrom.label + "</p><p style =\"font-size:12px;color:DeepSkyBlue\">(" + newDataFrom.info.typeName + ")</p></div>";
                            }
                        // }
                    // }
            ...
            if (fromData.amount == $toAmount) {
                ...
                if (toData != undefined) {
                    ...
                    if (toData.name == "orderbox") {
                        ...
                        ItemLabel = '<div class="item-slot-label"><p>' + toData.label + "</p><p style =\"font-size:12px;color:DeepSkyBlue\">(" + toData.info.typeName + ")</p></div>";
                    }
                ...
                // if (newDataTo.name.split("_")[0] == "weapon") {
                    // if (!Inventory.IsWeaponBlocked(newDataTo.name)) {
                        ...
                        if (newDataTo.name == "orderbox") {
                            ItemLabel = '<div class="item-slot-label"><p>' + newDataTo.label + "</p><p style =\"font-size:12px;color:DeepSkyBlue\">(" + newDataTo.info.itemName + ")</p></div>";
                        } else if (newDataTo.name == "lootbag") {
                            ItemLabel = '<div class="item-slot-label"><p>' + newDataTo.label + "</p><p style =\"font-size:12px;color:DeepSkyBlue\">(" + newDataTo.info.typeName + ")</p></div>";
                        }
                    // }
                // }
...
(() => {
    ...
    Inventory.Open = function(data) {
        ...
        var m = formatMoney(data.money)
        // $(".player-inv-label").html(data.Name);
        $(".player-inv-label").html('<i class="fa fa-id-badge"></i> '+ data.Name +' | '+'<i class="fas fa-wallet"></i>'+' '+ m);
                ...
                if (item != null) {
                    ...
                    // if (item.name.split("_")[0] == "weapon") {
                        // if (!Inventory.IsWeaponBlocked(item.name)) {
                            ...
                            if (item.name == "orderbox") { //style =\"font-size:13px\"
                                ItemLabel = '<div class="item-slot-label"><p>' + item.label + "</p><p style =\"font-size:12px;color:DeepSkyBlue\">(" + item.info.itemName + ")</p></div>";
                            } else if (item.name == "lootbag") {
                                ItemLabel = '<div class="item-slot-label"><p>' + item.label + "</p><p style =\"font-size:12px;color:DeepSkyBlue\">(" + item.info.typeName + ")</p></div>";
                            }
                        // }
                    // }
                    if (item.slot < 6) {
