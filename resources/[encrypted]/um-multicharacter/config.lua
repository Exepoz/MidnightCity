...
Config.AnimationMenu = 'rpemotes' -- rpemotes, scully, other [list/animationlist.lua]
...
]]    spawnEventUI = 'ps-housing:client:setupSpawnUI',
...
Config.DefaultSpawn = { -- If ApartmentStart is false, it spawns the [new character here]
    ...
    Single = vector4(964.87, -2337.72, 30.56, 220.56)
}
...
Config.Coords = {
    Single = Coords.List[15], -- If random false [list/coordslist.lua]
    Random = false
}

Config.Effects = {
    Status = true, -- If you want to use effects, you can make it true.
    Single = Effect.List[3], -- If random false [list/effectlist.lua]
    Random = false
}
