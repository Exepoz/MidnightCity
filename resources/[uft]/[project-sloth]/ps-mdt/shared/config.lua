...
-- Google Docs Link
Config.sopLink = {
    ['police'] = 'https://docs.google.com/document/d/11ayC3FMyh3V7TLTdlFcgyJLMuLMQ-TFSZIszgiKYGM4/edit',
    ['ambulance'] = '',
    ['bcso'] = '',
    ['doj'] = '',
    ['sast'] = '',
...
-- Google Docs Link
Config.RosterLink = {
    ['police'] = 'https://docs.google.com/spreadsheets/d/13t5jwARNPOozAxNcqv_PKN-yecnD-iGUiI7ZGv1pMI0/edit?usp=sharing',
    ['ambulance'] = '',
    ['bcso'] = '',
    ['doj'] = '',
    ['sast'] = '',
