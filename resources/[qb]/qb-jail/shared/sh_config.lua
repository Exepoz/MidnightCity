...
Config.TargetDebug          = false -- Enables or disables target debug zones
...
Config.CraftingCost = {
    [1] = {
        ...
        durationLabel = 'Short',
        items = {
            [1] = { item = 'rubber', amount = 7 },
            [2] = { item = 'metalscrap', amount = 5 },
            [3] = { item = 'aluminum', amount = 2 }
        }
    },
    [2] = {
        item = 'prisonwine',
        ...
        items = {
            [1] = { item = 'prisonfruit', amount = 5 },
            [2] = { item = 'prisonsugar', amount = 8 },
            [3] = { item = 'prisonbag', amount = 1 },
            [4] = { item = 'prisonslushie', amount = 3 },
            [5] = { item = 'prisonjuice', amount = 3 }
        }
    },
    [3] = {
        item = 'prisonmeth',
        ...
        durationLabel = 'Long',
        items = {
            [1] = { item = 'prisonchemicals', amount = 5 },
            [2] = { item = 'prisonbag', amount = 1 },
            [3] = { item = 'prisonfarmnutrition', amount = 3 }
        }
    },
    [4] = {
        item = 'weapon_knife',
        ...
        durationLabel = 'Long',
        items = {
            [1] = { item = 'prisonspoon', amount = 1 },
            [2] = { item = 'prisonrock', amount = 2 }
        }
    }
}
