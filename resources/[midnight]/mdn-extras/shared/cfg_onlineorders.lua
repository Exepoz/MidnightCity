...
Config.OnlineOrders.Shops = {
    ...
    ['tools'] = {
        ...
        items = {
            ...
            [9] = {item = "sparkplugs",             price = 1000,    stock = 100, 	loc = 2, max = 25},
            [10] = {item = "carbattery",            price = 2000,     stock = 100, 	loc = 2, max = 25},
            [11] = {item = "axleparts",             price = 1234,    stock = 25, 	loc = 15, max = 25, },
            [12] = {item = "sparetire",             price = 500,    stock = 25, 	loc = 15, max = 25, },
            [13] = {item = "enginekit",             price = 800,    stock = 25, 	loc = 4, max = 10,},
            [14] = {item = "bodykit",               price = 2500,     stock = 100, 	loc = 2, max = 25},
    ...
    ['performance'] = {
        ...
        items = {
            [1] = {item = "engine1",          price = 16500,   	stock = 50,  loc = 1, max = 15, },
            [2] = {item = "engine2",          price = 23500,    	stock = 50,  loc = 1, max = 15, },
            [3] = {item = "engine3",          price = 32000,     stock = 50,  loc = 1, max = 15, },
            [4] = {item = "engine4",          price = 38000,    	stock = 50,  loc = 1, max = 15, },
            [5] = {item = "transmission1",    price = 11500,    	stock = 50,  loc = 1, max = 15, },
            [6] = {item = "transmission2",    price = 21500,    	stock = 50,  loc = 1, max = 15, },
            [7] = {item = "transmission3",    price = 32000,    	stock = 50,  loc = 1, max = 15, },
            [8] = {item = "brakes1",          price = 8500,   	stock = 50,  loc = 3, max = 15, },
            [9] = {item = "brakes2",          price = 11500,    	stock = 50,  loc = 3, max = 15, },
            [10] = {item = "brakes3",         price = 15000,     stock = 50,  loc = 3, max = 15, },
            [11] = {item = "suspension1",     price = 10500,    	stock = 50,  loc = 3, max = 15, },
            ...
            [19] = {item = "drives1",         price = 7000,    	stock = 50,  loc = 1, max = 15, },
            [20] = {item = "drives2",         price = 14000,    	stock = 50,  loc = 1, max = 15, },
            [21] = {item = "drives3",         price = 21500,    	stock = 50,  loc = 1, max = 15, },
            [22] = {item = "cylind1",         price = 12500,    	stock = 50,  loc = 1, max = 15, },
            [23] = {item = "cylind2",         price = 15500,   	stock = 50,  loc = 3, max = 15, },
            [24] = {item = "cylind3",         price = 21500,    	stock = 50,  loc = 3, max = 15, },
            [25] = {item = "fueltank1",       price = 1500,    	stock = 50,  loc = 1, max = 15, },
            [26] = {item = "fueltank2",       price = 2700,   	stock = 50,  loc = 3, max = 15, },
            [27] = {item = "fueltank3",       price = 4100,    	stock = 50,  loc = 3, max = 15, },
            [28] = {item = "cables1",         price = 3200,     stock = 50,  loc = 3, max = 15, },
    ...
    ['cosmetics'] = {
        ...
        items = {
            [1] = {item = "tint_supplies",  price = 500,   	stock = 50, 	loc = 2, max = 15},
            [2] = {item = "tires",          price = 1000,    stock = 50, 	loc = 2, max = 15},
            [3] = {item = "roof",           price = 1100,    stock = 50, 	loc = 1, max = 15, },
            [4] = {item = "internals",      price = 1200,    stock = 100, 	loc = 2, max = 25, },
            [5] = {item = "customplate",    price = 1000,    stock = 50, 	loc = 2, max = 15, },
            [6] = {item = "seat",           price = 1350,    stock = 50, 	loc = 4, max = 15, },
            [7] = {item = "rims",           price = 3000,    stock = 50, 	loc = 4, max = 15, },
            [8] = {item = "hood",           price = 1160,   	stock = 50, 	loc = 5, max = 15, },
            [9] = {item = "skirts",         price = 1500,    stock = 50, 	loc = 5, max = 15, },
            [10] = {item = "bumper",        price = 1690,    stock = 50, 	loc = 5, max = 15, },
            [11] = {item = "externals",     price = 1000,    stock = 100, 	loc = 5, max = 25, },
            [12] = {item = "headlights",    price = 5000,    stock = 50, 	loc = 5, max = 15, },
            [13] = {item = "spoiler",       price = 3800,    stock = 50, 	loc = 5, max = 15, },
            [14] = {item = "rollcage",      price = 4500,    stock = 50, 	loc = 5, max = 15, },
            [15] = {item = "exhaust",       price = 2500,    stock = 25, 	loc = 4, max = 15, },
