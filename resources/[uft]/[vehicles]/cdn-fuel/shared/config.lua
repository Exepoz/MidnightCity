...
Config.CostMultiplier = 2 -- Amount to multiply 1 by. This indicates fuel price. (Default: $3.0/l or 3.0)
Config.GlobalTax = 11.0 -- The tax, in %, that people will be charged at the pump. (Default: 15% or 15.0)
...
Config.StationFuelSalePercentage = 0.30 -- % of sales that the station gets. If they sell 4 Liters of Gas for $16 (not including taxes), they will get 16*Config.StationFuelSalePercentage back from the sale. Treat this as tax, also, it balances the profit margins a bit.
