...
Config.Heists = {
    ...
    houseRobbery = {
        ...
        ['ChanceLoot'] = {
            ...
            minLoot = 1,
            pool = {
                [1] = {item = "weapon_dp9",         amt = {min = 1, max = 1}, probability = 1/3},
                [2] = {item = "weapon_browning",    amt = {min = 1, max = 1}, probability = 1/3},
                [3] = {item = "malmocoke_brick",    amt = {min = 2, max = 3}, probability = 1/5},
                [4] = {item = "malmo_laptop",       amt = {min = 1, max = 1}, probability = 1/10},
                [5] = {item = "decrypter",          amt = {min = 1, max = 1}, probability = 1/7},
            },
        },
    },
