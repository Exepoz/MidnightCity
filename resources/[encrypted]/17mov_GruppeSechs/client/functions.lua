...
Config.WrongNotifications = {
    ...
    ["nobodyNearby"] = true,
    ["cantInvite"] = true,
    ["cantInviteCrime"] = true,
    ["spawnpointOccupied"] = true,
    ["notAllBags"] = true,
    ["notEverythingDone"] = true,
    ["someonesInside"] = true,
    ["cantOpenTabletWhileOnDuty"] = true,
    ["alreadyBusy"] = true,
    ["tooLate"] = true,
    ["didntMakeThirdStep"] = true,
    ["notADriver"] = true,
    ["partyIsFull"] = true,
    ["wrongReward1"] = true,
    ["wrongReward2"] = true,
