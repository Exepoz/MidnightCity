Config = {
	...
	Harness = {
		...
		crashKill = false			-- Set to true if you want ejecting when crashing to kill
	},
	CarLifts = {
	...
	Odometer = {
		...
		OdoLocation  = "bottom-left", 	-- Where the Odometer will show,
...
Config.NOS.NitrousUseRate = {
	[1] = 0.1,
	[2] = 0.25,
	[3] = 0.50,
}

Config.Repairs.Crumbs = {
	["engine"] = 1000,
	["body"] = 1000,
	["oil"] = 1000,
	["axle"] = 1000,
